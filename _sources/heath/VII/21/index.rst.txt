...
.. figure:: VII.21.graphic.inverted.png
...
And, since C measures A according to the units in E, therefore E also measures A according to the units in C. [:ref:`VII.16`]

For the same reason E also measures B according to the units in D. [:ref:`VII.16`]

Therefore E measures A, B which are prime to one another: which is impossible. [:ref:`VII.def.12`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.21" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VII/21/", target="_top"];
