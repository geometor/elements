...
.. figure:: VII.1.graphic.inverted.png
...
Therefore no number will measure the numbers AB, CD; therefore AB, CD are prime to one another. [:ref:`VII.def.12`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.1" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VII/1/", target="_top"];
     "VII.1" -> "VII.def.12";
   }
