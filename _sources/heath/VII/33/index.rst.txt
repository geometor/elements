...
.. figure:: VII.33.graphic.inverted.png
...
Now, if A, B, C are prime to one another, they are the least of those which have the same ratio with them. [:ref:`VII.21`]

But, if not, let D the greatest common measure of A, B, C be taken, [:ref:`VII.3`] and, as many times as D measures the numbers A, B, C
respectively, so many units let there be in the numbers E, F, G respectively.

Therefore the numbers E, F, G measure the numbers A, B, C respectively according to the units in D. [:ref:`VII.16`]

Therefore E, F, G measure A, B, C the same number of times; therefore E, F, G are in the same ratio with A, B, C. [:ref:`VII.def.20`]
...
And, since H measures A according to the units in M, therefore M also measures A according to the units in H. [:ref:`VII.16`]
...
Now, since H measures A according to the units in M, therefore H by multiplying M has made A. [:ref:`VII.def.15`]

For the same reason also E by multiplying D has made A.

Therefore the product of E, D is equal to the product of H, M.

Therefore, as E is to H, so is M to D. [:ref:`VII.19`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.33" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VII/33/", target="_top"];
