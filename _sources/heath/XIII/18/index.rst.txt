...
But the square on the diameter of the sphere is also five times the square on the radius of the circle from which the icosahedron has been described. [:ref:`XIII.16.p.1`]

And AB is the diameter of the sphere; therefore KL is the radius of the circle from which the icosahedron has been described; therefore KL is a side of the hexagon in the said circle. [:ref:`IV.15.p.1`]

And, since the diameter of the sphere is made up of the side of the hexagon and two of the sides of the decagon inscribed in the same circle, [:ref:`XIII.16.p.1`] and AB is the diameter of the sphere, while KL is a side of the hexagon, and AK is equal to LB, therefore each of the straight lines AK, LB is a side of the decagon inscribed in the circle from which the icosahedron has been described.
...
Now, since FB is a side of the cube, let it be cut in extreme and mean ratio at N, and let NB be the greater segment; therefore NB is a side of the dodecahedron. [:ref:`XIII.17.p.1`]
...
And, since the three straight lines are proportional, as the first is to the third, so is the square on the first to the square on the second; [:ref:`V.def.9`, :ref:`VI.20.p.1`] therefore, as DB is to BA, so is the square on DB to the square on BF; therefore, inversely, as AB is to BD, so is the square on FB to the square on BD.
...
.. graphviz::
   ...
   digraph {
     ...
     "X.23.p.1" [style="rounded,filled", fillcolor=orange];
     "XIII.16.p.1" [style="rounded,filled", fillcolor=orange];
     ...
     "X.16.l.1" [style="rounded,filled", fillcolor=orange];
     ...
     "V.19.p.1" [style="rounded,filled", fillcolor=orange];
     ...
     "X.def.3.1" [style="rounded,filled", fillcolor=orange, URL="/heath/X/def.3.1/", target="_top"];
     ...
     "VI.8.p.1" [style="rounded,filled", fillcolor=orange];
     ...
     "X.28.l.2" [style="rounded,filled", fillcolor=orange];
     ...
     "X.def.3.4" [style="rounded,filled", fillcolor=orange, URL="/heath/X/def.3.4/", target="_top"];
     ...
     "X.6.p.1" [style="rounded,filled", fillcolor=orange];
     ...
     "XIII.17.p.1" [style="rounded,filled", fillcolor=orange];
