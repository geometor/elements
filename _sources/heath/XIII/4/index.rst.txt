...
Since then AB has been cut in extreme and mean ratio at C, and AC is the greater segment, therefore the rectangle AB, BC is equal to the square on AC. [:ref:`VI.def.3 <VI.def.3>`, :ref:`VI.17 <VI.17>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XIII.4" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XIII/4/", target="_top"];
