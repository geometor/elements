...
:type: prop
:tags: line
:dependencies: VI.17, VI.def.3




.. figure:: XIII.4.graphic.inverted.png
...
Since then AB has been cut in extreme and mean ratio at C, and AC is the greater segment, therefore the rectangle AB, BC is equal to the square on AC. [:ref:`VI.def.3`, :ref:`VI.17`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XIII.4" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XIII/4/", target="_top"];
