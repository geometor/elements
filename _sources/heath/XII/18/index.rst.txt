...
But, inasmuch as LMN is greater than DEF, therefore, as the sphere LMN is to the sphere ABC, so is the sphere DEF to some less sphere than the sphere ABC, as was before proved. [:ref:`XII.2.l.1 <XII.2.l.1>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XI.def.14" [fillcolor="#224422", URL="/heath/XI/def.14/", target="_top"];
     ...
     "XII.17" [fillcolor="#222244", URL="/heath/XII/17/", target="_top"];
     ...
     "XII.18" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XII/18/", target="_top"];
     ...
     "XI.18" [fillcolor="#222244", URL="/heath/XI/18/", target="_top"];
