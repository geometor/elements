...
:number: 589
:type: prop
:dependencies: V.16, XII.17, elem.12.17.p.1, elem.12.2.l.1




.. figure:: XII.18.graphic.inverted.png
...
But, inasmuch as LMN is greater than DEF, therefore, as the sphere LMN is to the sphere ABC, so is the sphere DEF to some less sphere than the sphere ABC, as was before proved. [:ref:`elem.12.2.l.1`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XII.17" [URL="/heath/XII/17/", target="_top"];
     ...
     "elem.12.17.p.1" [style="rounded,filled", fillcolor=orange];
     ...
     "XII.18" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XII/18/", target="_top"];
