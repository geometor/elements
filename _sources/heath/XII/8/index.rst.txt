...
.. figure:: XII.8.graphic.inverted.png
...
But the three parallelograms MB, BK, BN are equal and similar to their three opposites, and the three EQ, EO, ER are equal and similar to their three opposites. [:ref:`XI.24`]
...
But similar parallelepipedal solids are in the triplicate ratio of their corresponding sides. [:ref:`XI.33`]
...
But, as the solid BGML is to the solid EHQP, so is the pyramid ABCG to the pyramid DEFH, inasmuch as the pyramid is a sixth part of the solid, because the prism which is half of the parallelepipedal solid [:ref:`XI.28`] is also triple of the pyramid. [:ref:`XII.7`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XII.8" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XII/8/", target="_top"];
