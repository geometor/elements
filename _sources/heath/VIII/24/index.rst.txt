...
Therefore one mean proportional number falls between C, D. [:ref:`VIII.18`]

And, as C is to D, so is A to B; therefore one mean proportional number falls between A, B also. [:ref:`VIII.8`]

And A is square; therefore B is also square. [:ref:`VIII.22`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "VIII.24" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VIII/24/", target="_top"];
