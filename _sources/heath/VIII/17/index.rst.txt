...
:number: 327
:type: prop
:dependencies: VIII.15




.. figure:: VIII.17.graphic.inverted.png
...
For if C measures D, A will also measure B. [:ref:`VIII.15 <VIII.15>`]

But A does not measure B; therefore neither does C measure D.

Again, let C not measure D; I say that neither will A measure B.

For, if A measures B, C will also measure D. [:ref:`VIII.15 <VIII.15>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VIII.17" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VIII/17/", target="_top"];
     ...
     "VIII.15" [fillcolor="#222244", URL="/heath/VIII/15/", target="_top"];
