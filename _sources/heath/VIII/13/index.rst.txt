...
.. figure:: VIII.13.graphic.inverted.png
...
and, as G is to H, so is H to K. [:ref:`VII.14`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "VIII.13" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VIII/13/", target="_top"];
