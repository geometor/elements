...
:number: 337
:type: prop
:dependencies: VII.33, VIII.19, VIII.2, VIII.2.p.1
...
Let C, D so fall, and let E, F, G, H, the least numbers of those which have the same ratio with A, C, D, B, and equal with them in multitude, be taken; [:ref:`VII.33` or :ref:`VIII.2`] therefore the extremes of them E, H are cube. [:ref:`VIII.2.p.1`]
