...
For, since between A, D there are two mean proportional numbers B, C, therefore A, D are similar solid numbers. [:ref:`VIII.21 <VIII.21>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VIII.23" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VIII/23/", target="_top"];
