...
and, as D is to F, so is H to K. [:ref:`VIII.4`]

And let D by multiplying E make L.

Now, since D by multiplying C has made A, and by multiplying E has made L, therefore, as C is to E, so is A to L. [:ref:`VII.17`]

But, as C is to E, so is G to H; therefore also, as G is to H, so is A to L.

Again, since E by multiplying D has made L, and further by multiplying F has made B, therefore, as D is to F, so is L to B. [:ref:`VII.17`]
...
.. container:: center
   ...
   as G is to K, so is A to B. [:ref:`VII.14`]
...
1, 5, 29, 31. compounded of the ratios of their sides. As in :ref:`VI.23`, the Greek has the less exact phrase, compounded of their sides.
...
.. graphviz::
   ...
   digraph {
     ...
     "VI.23" [URL="/heath/VI/23/", target="_top"];
     ...
     "VIII.5" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VIII/5/", target="_top"];
