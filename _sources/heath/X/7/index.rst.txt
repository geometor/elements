...
.. figure:: X.7.graphic.inverted.png
...
For, if A has to B the ratio which a number has to a number, A will be commensurable with B. [:ref:`X.6`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.7" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/7/", target="_top"];
