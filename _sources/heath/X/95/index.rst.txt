...
:type: prop
:tags: line
:dependencies: VI.26, X.18, X.19, X.21, X.77, elem.10.def.3.5




.. figure:: X.95.graphic.inverted.png
...
the annex GD is commensurable in length with the rational straight line AC set out, and the square on the whole AG is greater than the square on the annex DG by the square on a straight line incommensurable with AG. [:ref:`elem.10.def.3.5`]

Therefore, if there be applied to AG a parallelogram equal to the fourth part of the square on DG and deficient by a square figure, it will divide it into incommensurable parts. [:ref:`X.18`]
...
Now, since AG is incommensurable in length with CA, and both are rational, therefore AK is medial. [:ref:`X.21`]

Again, since DG is rational and commensurable in length with AC, DK is rational. [:ref:`X.19`]

Now let the square LM be constructed equal to AI, and let the square NO equal to FK and about the same angle, the angle LPM, be subtracted; therefore the squares LM, NO are about the same diameter. [:ref:`VI.26`]
...
Therefore the remainder LN is the irrational straight line called that which produces with a rational area a medial whole; [:ref:`X.77`] and it is the side
of the area AB.
...
.. graphviz::
   ...
   digraph {
     ...
     "elem.2.7 elem.10.16" [style="rounded,filled", fillcolor=orange];
     ...
     "X.77" [URL="/heath/X/77/", target="_top"];
     ...
     "X.95" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/95/", target="_top"];
     ...
     "elem.10.def.3.5" [style="rounded,filled", fillcolor=orange];
