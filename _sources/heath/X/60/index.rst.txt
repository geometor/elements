...
:type: prop
:tags: line
:dependencies: VI.1, VI.17, X.11, X.13, X.15, X.17, X.20, X.21, X.22, X.36, X.53.l.1, X.59.l.1, X.def.2.1
...
Since the rectangle AC, CB is a mean proportional between the squares on AC, CB, [cf. :ref:`X.53.l.1`] therefore MO is also a mean proportional between DH, KL.
...
And, since the squares on AC, CB are greater than twice the rectangle AC, CB, [:ref:`X.59.l.1`] therefore DL is also greater than MF, so that DM is also greater than MG. [:ref:`VI.1`]
...
Therefore DG is a first binomial straight line. [:ref:`X.def.2.1`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "X.59.l.1" [style="rounded,filled", fillcolor=orange];
