...
Let it be contrived that, as DE is to EF, so is the square on BG to the square on GC; [:ref:`X.6.p.1`] therefore the square on BG is commensurable with the square on GC. [:ref:`X.6`]
...
Since then, as DE is to EF, so is the square on BG to the square on GC, therefore also, convertendo, as ED is to DF, so is the square on GB to the square on H. [:ref:`V.19.p.1`]
...
Therefore BC is a fourth apotome. [:ref:`X.def.3.4`]
