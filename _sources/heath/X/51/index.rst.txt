...
:type: prop
:tags: line
:dependencies: V.19.p.1, X.6, X.6.p.1, X.9
...
Let it be contrived that, as the number BA is to AC, so is the square on EF to the square on FG; [:ref:`X.6.p.1`] therefore the square on EF is commensurable with the square on FG; [:ref:`X.6`] therefore FG is also rational.
...
Let then the squares on FG, H be equal to the square on EF; therefore, convertendo, as the number AB is to BC, so is the square on EF to the square on H. [:ref:`V.19.p.1`]
