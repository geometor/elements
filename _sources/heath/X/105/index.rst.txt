...
But the rectangle AE, EB is medial; [:ref:`X.76`] therefore the rectangle CF, FD is also medial; [:ref:`X.23.p.1`] therefore CF, FD are straight lines incommensurable in square which make the sum of the squares on them rational, but the rectangle contained by them medial.
