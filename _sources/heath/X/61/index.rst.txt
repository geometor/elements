...
:type: prop
:tags: line
:dependencies: VI.1, X.11, X.13, X.17, X.20, X.21, X.22, X.36, X.37, X.def.2.2, elem.10.15 elem.10.23.p.1
...
Therefore DG is a second binomial straight line. [:ref:`X.def.2.2`]
