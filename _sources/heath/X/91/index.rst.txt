...
:type: None
:tags: line
:dependencies: V.11, VI.1, VI.17, VI.26, X.11, X.12, X.13, X.15, X.17, X.19, X.21, X.73, elem.10.53.l.1, elem.10.def.3.1




.. figure:: X.91.graphic.inverted.png
...
For, since AD is a first apotome, let DG be its annex; therefore AG, GD are rational straight lines commensurable in square only. [:ref:`X.73`]

And the whole AG is commensurable with the rational straight line AC set out, and the square on AG is greater than the square on GD by the square on a straight line commensurable in length with AG; [:ref:`elem.10.def.3.1`] if therefore there be applied to AG a parallelogram equal to the fourth part of the square on DG and deficient by a square figure, it divides it into commensurable parts. [:ref:`X.17`]
...
Now, since AF is commensurable in length with FG, therefore AG is also commensurable in length with each of the straight lines AF, FG. [:ref:`X.15`]

But AG is commensurable with AC; therefore each of the straight lines AF, FG is commensurable in length with AC. [:ref:`X.12`]

And AC is rational; therefore each of the straight lines AF, FG is also rational, so that each of the rectangles AI, FK is also rational. [:ref:`X.19`]

Now, since DE is commensurable in length with EG, therefore DG is also commensurable in length with each of the straight lines DE, EG. [:ref:`X.15`]

But DG is rational and incommensurable in length with AC; therefore each of the straight lines DE, EG is also rational and incommensurable in length with AC; [:ref:`X.13`] therefore each of the rectangles DH, EK is medial. [:ref:`X.21`]

Now let the square LM be made equal to AI, and let there be subtracted the square NO having a common angle with it, the angle LPM, and equal to FK; therefore the squares LM, NO are about the same diameter. [:ref:`VI.26`]

Let PR be their diameter, and let the figure be drawn.

Since then the rectangle contained by AF, FG is equal to the square on EG, therefore, as AF is to EG, so is EG to FG. [:ref:`VI.17`]

But, as AF is to EG, so is AI to EK, and, as EG is to FG, so is EK to KF; [:ref:`VI.1`] therefore EK is a mean proportional between AI, KF. [:ref:`V.11`]

But MN is also a mean proportional between LM, NO, as was before proved, [:ref:`elem.10.53.l.1`] and AI is equal to the square LM, and KF to NO; therefore MN is also equal to EK.
...
But, as LO is to NO, so is LP to PN; [:ref:`VI.1`] therefore LP is incommensurable in length with PN. [:ref:`X.11`]

And both are rational; therefore LP, PN are rational straight lines commensurable in square only; therefore LN is an apotome. [:ref:`X.73`]
...
.. graphviz::
   ...
   digraph {
     ...
     "elem.10.53.l.1" [style="rounded,filled", fillcolor=orange];
     ...
     "X.91" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/91/", target="_top"];
