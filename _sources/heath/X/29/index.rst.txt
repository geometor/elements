...
:type: prop
:tags: line
:dependencies: I.47, III.31, X.6, X.9, X.def.4, elem.10.28.l.1, elem.10.6.p.1, elem.5.19.p.1




.. figure:: X.29.graphic.inverted.png
...
For let there be set out any rational straight line AB, and two square numbers CD, DE such that their difference CE is not square; [:ref:`elem.10.28.l.1`] let there be described on AB the semicircle AFB, and let it be contrived that,


.. container:: center

   as DC is to CE, so is the square on BA to the square on AF. [:ref:`elem.10.6.p.1`]


Let FB be joined.

Since, as the square on BA is to the square on AF, so is DC to CE, therefore the square on BA has to the square on AF the ratio which the number DC has to the number CE; therefore the square on BA is commensurable with the square on AF. [:ref:`X.6`]

But the square on AB is rational; [:ref:`X.def.4`] therefore the square on AF is also rational; [id.] therefore AF is also rational.

And, since DC has not to CE the ratio which a square number has to a square number, neither has the square on BA to the square on AF the ratio which a square number has to a square number; therefore AB is incommensurable in length with AF. [:ref:`X.9`]

Therefore BA, AF are rational straight lines commensurable in square only.

And since, as DC is to CE, so is the square on BA to the square on AF, therefore, convertendo, as CD is to DE, so is the square on AB to the square on BF. [:ref:`elem.5.19.p.1`, :ref:`III.31`, :ref:`I.47`]

But CD has to DE the ratio which a square number has to a square number: therefore also the square on AB has to the square on BF the ratio which a square number has to a square number; therefore AB is commensurable in length with BF. [:ref:`X.9`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.29" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/29/", target="_top"];
