...
For let there be set out any rational straight line AB, and two square numbers CD, DE such that their difference CE is not square; [:ref:`X.28.l.1`] let there be described on AB the semicircle AFB, and let it be contrived that,


.. container:: center

   as DC is to CE, so is the square on BA to the square on AF. [:ref:`X.6.p.1`]
...
And since, as DC is to CE, so is the square on BA to the square on AF, therefore, convertendo, as CD is to DE, so is the square on AB to the square on BF. [:ref:`V.19.p.1`, :ref:`III.31`, :ref:`I.47`]
