...
Now the greater straight line HE is commensurable in length with the rational straight line EF set out; therefore EK is a first binomial. [:ref:`X.def.2.1`]
...
Now the greater straight line EH is commensurable in length with the rational straight line EF set out; therefore EK is a fourth binomial. [:ref:`X.def.2.4`]
...
Now the lesser straight line EH is commensurable in length with the rational straight line EF set out; therefore EK is a second binomial. [:ref:`X.def.2.2`]
...
Now the lesser straight line EH is commensurable with the rational straight line EF set out; therefore EK is a fifth binomial. [:ref:`X.def.2.5`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.18.l.1" [style="rounded,filled", fillcolor=orange];
     "V.16" [URL="/heath/V/16/", target="_top"];
     "VII.33" [URL="/heath/VII/33/", target="_top"];
     "VII.9" [URL="/heath/VII/9/", target="_top"];
     "X.def.2.4" [style="rounded,filled", fillcolor=orange, URL="/heath/X/def.2.4/", target="_top"];
     ...
     "X.def.2.1" [style="rounded,filled", fillcolor=orange, URL="/heath/X/def.2.1/", target="_top"];
     ...
     "X.def.2.5" [style="rounded,filled", fillcolor=orange, URL="/heath/X/def.2.5/", target="_top"];
     ...
     "X.def.2.2" [style="rounded,filled", fillcolor=orange, URL="/heath/X/def.2.2/", target="_top"];
     ...
     "X.28.l.1" [style="rounded,filled", fillcolor=orange];
