...
:type: None
:tags: line
:dependencies: VI.1, X.11, X.20, X.22, X.36, X.54, X.55, X.57, X.58, elem.10.def.2.1, elem.10.def.2.2, elem.10.def.2.4, elem.10.def.2.5




.. figure:: X.71.graphic.inverted.png
...
And it has been applied to EF, producing EH as breadth; therefore EH is rational and commensurable in length with EF. [:ref:`X.20`]

Again, since CD is medial and is equal to HI, therefore HI is also medial.

And it is applied to the rational straight line EF, producing HK as breadth; therefore HK is rational and incommensurable in length with EF [:ref:`X.22`]
...
But, as EG is to HI, so is EH to HK; [:ref:`VI.1`] therefore EH is also incommensurable in length with HK. [:ref:`X.11`]

And both are rational; therefore EH, HK are rational straight lines commensurable in square only; therefore EK is a binomial straight line, divided at H. [:ref:`X.36`]
...
Now the greater straight line HE is commensurable in length with the rational straight line EF set out; therefore EK is a first binomial. [:ref:`elem.10.def.2.1`]

But EF is rational; and, if an area be contained by a rational straight line and the first binomial, the side of the square equal to the area is binomial. [:ref:`X.54`]
...
Now the greater straight line EH is commensurable in length with the rational straight line EF set out; therefore EK is a fourth binomial. [:ref:`elem.10.def.2.4`]

But EF is rational; and, if an area be contained by a rational straight line and the fourth binomial, the side
of the area is the irrational straight line called major. [:ref:`X.57`]
...
Now the lesser straight line EH is commensurable in length with the rational straight line EF set out; therefore EK is a second binomial. [:ref:`elem.10.def.2.2`]

But EF is rational, and, if an area be contained by a rational straight line and the second binomial, the side of the square equal to it is a first bimedial; [:ref:`X.55`] therefore the side
...
Now the lesser straight line EH is commensurable with the rational straight line EF set out; therefore EK is a fifth binomial. [:ref:`elem.10.def.2.5`]

But EF is rational; and, if an area be contained by a rational straight line and the fifth binomial, the side of the square equal to the area is a side of a rational plus a medial area. [:ref:`X.58`]
...
.. graphviz::
   ...
   digraph {
     ...
     "elem.10.def.2.1" [style="rounded,filled", fillcolor=orange];
     ...
     "elem.10.def.2.4" [style="rounded,filled", fillcolor=orange];
     "elem.7.2.p.1" [style="rounded,filled", fillcolor=orange];
     "elem.10.def.2.2" [style="rounded,filled", fillcolor=orange];
     ...
     "II.14" [URL="/heath/II/14/", target="_top"];
     ...
     "X.71" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/71/", target="_top"];
     ...
     "X.57" [URL="/heath/X/57/", target="_top"];
     ...
     "X.58" [URL="/heath/X/58/", target="_top"];
     "VI.12" [URL="/heath/VI/12/", target="_top"];
     "X.37" [URL="/heath/X/37/", target="_top"];
     ...
     "X.39" [URL="/heath/X/39/", target="_top"];
     ...
     "X.54" [URL="/heath/X/54/", target="_top"];
     ...
     "elem.10.6 elem.10.23.p.1" [style="rounded,filled", fillcolor=orange];
     ...
     "X.55" [URL="/heath/X/55/", target="_top"];
     ...
     "VI.16" -> "VI.14";
     "X.22" -> "VI.14";
     "X.54" -> "elem.10.def.2.1";
     "X.71" -> "elem.10.def.2.1";
     "X.11" -> "X.8";
     ...
     "X.57" -> "X.18";
     "X.58" -> "X.18";
     "X.57" -> "elem.10.def.2.4";
     "X.71" -> "elem.10.def.2.4";
     "VII.3" -> "elem.7.2.p.1";
     "X.55" -> "elem.10.def.2.2";
     "X.71" -> "elem.10.def.2.2";
