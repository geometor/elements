...
:number: 476
:type: None
:dependencies: V.22, X.6, X.73, X.9, elem.10.6.p.1, elem.10.def.3.3, elem.5.19.p.1




.. figure:: X.87.graphic.inverted.png
...
Let it be contrived that, as E is to BC, so is the square on A to the square on FG, and, as BC is to CD, so is the square on FG to the square on GH. [:ref:`elem.10.6.p.1`]

Since then, as E is to BC, so is the square on A to the square on FG, therefore the square on A is commensurable with the square on FG. [:ref:`X.6`]

But the square on A is rational; therefore the square on FG is also rational; therefore FG is rational.

And, since E has not to BC the ratio which a square number has to a square number, therefore neither has the square on A to the square on FG the ratio which a square number has to a square number; therefore A is incommensurable in length with FG. [:ref:`X.9`]

Again, since, as BC is to CD, so is the square on FG to the square on GH, therefore the square on FG is commensurable with the square on GH. [:ref:`X.6`]

But the square on FG is rational; therefore the square on GH is also rational; therefore GH is rational.

And, since BC has not to CD the ratio which a square number has to a square number, therefore neither has the square on FG to the square on GH the ratio which a square number has to a square number; therefore FG is incommensurable in length with GH. [:ref:`X.9`]

And both are rational; therefore FG, GH are rational straight lines commensurable in square only; therefore FH is an apotome. [:ref:`X.73`]

I say next that it is also a third apotome.

For since, as E is to BC, so is the square on A to the square on FG, and, as BC is to CD, so is the square on FG to the square on HG, therefore, ex aequali, as E is to CD, so is the square on A to the square on HG. [:ref:`V.22`]

But E has not to CD the ratio which a square number has to a square number; therefore neither has the square on A to the square on GH the ratio which a square number has to a square number; therefore A is incommensurable in length with GH. [:ref:`X.9`]
...
Since then, as BC is to CD, so is the square on FG to the square on GH, therefore, convertendo, as BC is to BD, so is the square on FG to the square on K. [:ref:`elem.5.19.p.1`]
...
Therefore FG is commensurable in length with K, [:ref:`X.9`] and the square on FG is greater than the square on GH by the square on a straight line commensurable with FG.

And neither of the straight lines FG, GH is commensurable in length with the rational straight line A set out; therefore FH is a third apotome. [:ref:`elem.10.def.3.3`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.87" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/87/", target="_top"];
