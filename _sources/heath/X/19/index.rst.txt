...
.. figure:: X.19.graphic.inverted.png
...
And, as BD is to BC, so is DA to AC. [:ref:`VI.1`]

Therefore DA is commensurable with AC. [:ref:`X.11`]

But DA is rational; therefore AC is also rational. [:ref:`X.def.4`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.19" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/19/", target="_top"];
