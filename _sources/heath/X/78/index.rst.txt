...
.. figure:: X.78.graphic.inverted.png
...
For from the straight line AB let there be subtracted the straight line BC incommensurable in square with AB and fulfilling the given conditions; [:ref:`X.35`]
...
Therefore the remainder FE is equal to the square on AC, [:ref:`II.7`] so that AC is the side
of FE.
...
And it is applied to the rational straight line DI, producing DF as breadth; therefore DF is also rational and incommensurable in length with DI. [:ref:`X.22`]
...
But, as DE is to DH, so also is DG to DF; [:ref:`VI.1`] therefore DG is incommensurable with DF. [:ref:`X.11`]

And both are rational; therefore GD, DF are rational straight lines commensurable in square only.

Therefore FG is an apotome. [:ref:`X.73`]

And FH is rational; but the rectangle contained by a rational straight line and an apotome is irrational, [deduction from :ref:`X.20`] and its side
is irrational.
...
.. graphviz::
   ...
   digraph {
     ...
     "X.78" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/78/", target="_top"];
