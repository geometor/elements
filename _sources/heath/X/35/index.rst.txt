...
:type: prop
:tags: line
:dependencies: I.47, III.31, X.11, X.13, X.18, X.32, elem.10.32.l.1, elem.10.32.p.1




.. figure:: X.35.graphic.inverted.png
...
Let there be set out two medial straight lines AB, BC commensurable in square only, containing a medial rectangle, and such that the square on AB is greater than the square on BC by the square on a straight line incommensurable with AB; [:ref:`X.32`
, ad fin.] let the semicircle ADB be described on AB, and let the rest of the construction be as above.

Then, since AF is incommensurable in length with FB, [:ref:`X.18`
] AD is also incommensurable in square with DB. [:ref:`X.11`
]

And, since the square on AB is medial, therefore the sum of the squares on AD, DB is also medial. [:ref:`III.31`
, :ref:`I.47`
]
...
But the rectangle AB, BC is medial; therefore the rectangle AB, FD is also medial. [:ref:`elem.10.32.p.1`]

And it is equal to the rectangle AD, DB; [:ref:`elem.10.32.l.1`
] therefore the rectangle AD, DB is also medial.

And, since AB is incommensurable in length with BC, while CB is commensurable with BE, therefore AB is also incommensurable in length with BE, [:ref:`X.13`
] so that the square on AB is also incommensurable with the rectangle AB, BE. [:ref:`X.11`
]

But the squares on AD, DB are equal to the square on AB, [:ref:`I.47`
...
.. graphviz::
   ...
   digraph {
     ...
     "X.35" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/35/", target="_top"];
