...
Let it be contrived that, as ED is to DF, so is the square on BG to the square on GC; [:ref:`X.6.p.1`] therefore the square on BG is commensurable with the square on GC. [:ref:`X.6`]
...
Now since. as ED is to FD, so is the square on BG to the square on GC, therefore also, convertendo, [:ref:`V.19.p.1`] as DE is to EF, so is the square on GB to the square on H.
...
Therefore BC is a first apotome. [:ref:`X.def.3.1`]
