...
:type: prop
:tags: line
:dependencies: II.7, VI.1, X.11, X.13, X.22, X.23.p.1, X.6, X.73, X.75, X.79, elem.10.15 elem.10.23.p.1
...
Again, since the rectangle AC, CB is medial, twice the rectangle AC, CB is also medial. [:ref:`X.23.p.1`]
