...
:type: prop
:tags: line
:dependencies: V.11, V.16, V.19, X.11, X.23, X.23.p.1, X.37, X.38, elem.10.37 elem.10.38
...
If therefore the rectangle AE, EB is rational, the rectangle CF, FD is also rational, [and for this reason CD is a first bimedial]; [:ref:`X.37`] but if medial, medial, [:ref:`X.23.p.1`] and each of the straight lines AB, CD is a second bimedial. [:ref:`X.38`]
