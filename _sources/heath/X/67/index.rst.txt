...
:type: None
:tags: line
:dependencies: V.11, V.16, V.19, X.11, X.23, X.37, X.38, elem.10.23.p.1, elem.10.37 elem.10.38




.. figure:: X.67.graphic.inverted.png
...
For, since AB is bimedial, let it be divided into its medials at E; therefore AE, EB are medial straight lines commensurable in square only. [:ref:`elem.10.37 elem.10.38`]

And let it be contrived that, as AB is to CD, so is AE to CF; therefore also the remainder EB is to the remainder FD as AB is to CD. [:ref:`V.19`]

But AB is commensurable in length with CD; therefore AE, EB are also commensurable with CF, FD respectively. [:ref:`X.11`]

But AE, EB are medial; therefore CF, FD are also medial. [:ref:`X.23`]

And since, as AE is to EB, so is CF to FD, [:ref:`V.11`] and AE, EB are commensurable in square only, CF, FD are also commensurable in square only. [:ref:`X.11`]

But they were also proved medial; therefore CD is bimedial.

I say next that it is also the same in order with AB.

For since, as AE is to EB, so is CF to FD, therefore also, as the square on AE is to the rectangle AE, EB, so is the square on CF to the rectangle CF, FD; therefore, alternately, as the square on AE is to the square on CF, so is the rectangle AE, EB to the rectangle CF, FD. [:ref:`V.16`]
...
If therefore the rectangle AE, EB is rational, the rectangle CF, FD is also rational, [and for this reason CD is a first bimedial]; [:ref:`X.37`] but if medial, medial, [:ref:`elem.10.23.p.1`] and each of the straight lines AB, CD is a second bimedial. [:ref:`X.38`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.67" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/67/", target="_top"];
     ...
     "elem.10.37 elem.10.38" [style="rounded,filled", fillcolor=orange];
