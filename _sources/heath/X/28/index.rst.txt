...
:type: prop
:tags: line
:dependencies: II.6, IX.1, V.16, VI.12, VI.13, VI.16, VI.17, X.11, X.21, X.23, X.28.l.1, elem.9.24 elem.9.26
...
It is then manifest that the square product of AB, BC together with the square on CD is equal to the square on BD. [See :ref:`X.28.l.1`] 
