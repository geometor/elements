...
:type: prop
:tags: line
:dependencies: II.7, V.11, VI.1, VI.17, X.11, X.17, X.20, X.22, X.73, X.74, X.def.3.2, elem.10.15 elem.10.23.p.1
...
And the annex FM is commensurable in length with the rational straight line CD set out; therefore CF is a second apotome. [:ref:`X.def.3.2`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.def.3.2" [style="rounded,filled", fillcolor=orange, URL="/heath/X/def.3.2/", target="_top"];
