...
:type: None
:tags: line
:dependencies: II.4, VI.1, X.11, X.13, X.15, X.22, X.36, X.38, X.6, elem.10.41.l.1




.. figure:: X.44.graphic.inverted.png
...
Let AB be a second bimedial straight line divided at C, so that AC, CB are medial straight lines commensurable in square only and containing a medial rectangle; [:ref:`X.38`
...
Now let a rational straight line EF be set out, let there be applied to EF the rectangular parallelogram EK equal to the square on AB, and let EG equal to the squares on AC, CB be subtracted; therefore the remainder HK is equal to twice the rectangle AC, CB. [:ref:`II.4`
]

Again, let there be subtracted EL, equal to the squares on AD, DB, which were proved less than the squares on AC, CB [:ref:`elem.10.41.l.1`
...
And it is applied to the rational straight line EF; therefore EH is rational and incommensurable in length with EF. [:ref:`X.22`
]
...
But the squares on AC, CB are commensurable with the square on AC; for AC, CB are commensurable in square. [:ref:`X.15`
]

And twice the rectangle AC, CB is commensurable with the rectangle AC, CB. [:ref:`X.6`
]

Therefore the squares on AC, CB are also incommensurable with twice the rectangle AC, CB. [:ref:`X.13`
]

But EG is equal to the squares on AC, CB, and HK is equal to twice the rectangle AC, CB; therefore EG is incommensurable with HK, so that EH is also incommensurable in length with HN. [:ref:`VI.1`
, :ref:`X.11`
]

And they are rational; therefore EH, HN are rational straight lines commensurable in square only.

But, if two rational straight lines commensurable in square only be added together, the whole is the irrational which is called binomial. [:ref:`X.36`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.38" [URL="/heath/X/38/", target="_top"];
     ...
     "elem.10.41.l.1" [style="rounded,filled", fillcolor=orange];
     ...
     "X.44" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/44/", target="_top"];
