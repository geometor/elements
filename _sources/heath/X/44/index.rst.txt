...
Again, let there be subtracted EL, equal to the squares on AD, DB, which were proved less than the squares on AC, CB [:ref:`X.41.l.1`
...
.. graphviz::
   ...
   digraph {
     ...
     "X.41.l.1" [style="rounded,filled", fillcolor=orange];
