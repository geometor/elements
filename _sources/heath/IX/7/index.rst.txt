...
.. figure:: IX.7.graphic.inverted.png
...
For, since A is composite, it will be measured by some number. [:ref:`VII.def.13`]

Let it be measured by D; and, as many times as D measures A, so many units let there be in E.

Since then D measures A according to the units in E, therefore E by multiplying D has made A. [:ref:`VII.def.15`]
...
.. graphviz::
   ...
   digraph {
     ...
     "IX.7" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IX/7/", target="_top"];
     "VII.def.13" [style="rounded,filled", fillcolor=orange, URL="/heath/VII/def.13/", target="_top"];
     "IX.7" -> "VII.def.15";
     "IX.7" -> "VII.def.13";
   }
