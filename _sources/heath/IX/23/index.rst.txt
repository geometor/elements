...
.. figure:: IX.23.graphic.inverted.png
...
Let the unit DE be subtracted from CD; therefore the remainder CE is even. [:ref:`VII.def.7`]

But CA is also even; [:ref:`IX.22`] therefore the whole AE is also even. [:ref:`IX.21`]

And DE is an unit.

Therefore AD is odd. [:ref:`VII.def.7`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "IX.23" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IX/23/", target="_top"];
     "IX.22" -> "VII.def.7";
     "IX.23" -> "VII.def.7";
     "IX.22" -> "IX.21";
     "IX.23" -> "IX.21";
