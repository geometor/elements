...
:number: 352
:type: prop
:dependencies: II.3, II.4, VII.22, VII.24, VII.25, VII.28, VIII.2, elem.7.24 elem.7.25




.. figure:: IX.15.graphic.inverted.png
...
For let two numbers DE, EF, the least of those which have the same ratio with A, B, C, be taken. [:ref:`VIII.2`]

It is then manifest that DE by multiplying itself has made A, and by multiplying EF has made B, and, further, EF by multiplying itself has made C. [:ref:`VIII.2`]

Now, since DE, EF are least, they are prime to one another. [:ref:`VII.22`]

But, if two numbers be prime to one another, their sum is also prime to each; [:ref:`VII.28`] therefore DF is also prime to each of the numbers DE, EF.

But further DE is also prime to EF; therefore DF, DE are prime to EF.

But, if two numbers be prime to any number, their product is also prime to the other; [:ref:`VII.24`] so that the product of FD, DE is prime to EF; hence the product of FD, DE is also prime to the square on EF. [:ref:`VII.25`]

But the product of FD, DE is the square on DE together with the product of DE, EF; [:ref:`II.3`] therefore the square on DE together with the product of DE, EF is prime to the square on EF.
...
For, since DF is prime to each of the numbers DE, EF, the square on DF is also prime to the product of DE, EF. [:ref:`elem.7.24 elem.7.25`]

But the squares on DE, EF together with twice the product of DE, EF are equal to the square on DF; [:ref:`II.4`] therefore the squares on DE, EF together with twice the product of DE, EF are prime to the product of DE, EF.
...
.. graphviz::
   ...
   digraph {
     ...
     "elem.7.24 elem.7.25" [style="rounded,filled", fillcolor=orange];
     "I.9" [URL="/heath/I/9/", target="_top"];
     "IX.15" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IX/15/", target="_top"];
     ...
     "VII.28" [URL="/heath/VII/28/", target="_top"];
     ...
     "II.3" [URL="/heath/II/3/", target="_top"];
