...
.. figure:: IV.15.graphic.inverted.png
...
and therefore its three angles ``EGD``, ``GDE``, ``DEG`` are equal to one another, inasmuch as, in isosceles triangles, the angles at the base are equal to one another. [:ref:`I.5`]

And the three angles of the triangle are equal to two right angles; [:ref:`I.32`]
...
Therefore the angles ``EGD``, ``DGC``, ``CGB`` are equal to one another; so that the angles vertical to them, the angles ``BGA``, ``AGF``, ``FGE`` are equal. [:ref:`I.15`]

Therefore the six angles ``EGD``, ``DGC``, ``CGB``, ``BGA``, ``AGF``, ``FGE`` are equal to one another.

But equal angles stand on equal circumferences; [:ref:`III.26`] therefore the six circumferences ``AB``, ``BC``, ``CD``, ``DE``, ``EF``, ``FA`` are equal to one another.

And equal circumferences are subtended by equal straight lines; [:ref:`III.29`]
...
.. container:: center
   ...
   therefore the angle ``AFE`` is equal to the angle ``DEF``. [:ref:`III.27`]
...
.. graphviz::
   ...
   digraph {
     ...
     "III.29" [URL="/heath/III/29/", target="_top"];
     ...
     "IV.15" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IV/15/", target="_top"];
