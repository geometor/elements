...
through ``A``, ``B``, ``C``, ``D``, ``E`` let ``GH``, ``HK``, ``KL``, ``LM``, ``MG`` be drawn touching the circle; [:ref:`III.16.p.1`] let the centre ``F`` of the circle ``ABCDE`` be taken [:ref:`III.1`], and let ``FB``, ``FK``, ``FC``, ``FL``, ``FD`` be joined.
...
.. graphviz::
   ...
   digraph {
     ...
     "IV.12" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IV/12/", target="_top"];
     ...
     "IV.11" [URL="/heath/IV/11/", target="_top"];
