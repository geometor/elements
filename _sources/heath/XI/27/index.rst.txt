...
:categories: describe
:tags: line
:dependencies: V.22, VI.12, XI.def.9




.. figure:: XI.27.graphic.inverted.png
...
But the former three are both equal and similar to the three opposite parallelograms, and the latter three are both equal and similar to the three opposite parallelograms; therefore the whole solid CD is similar to the whole solid AL. [:ref:`XI.def.9`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XI.27" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XI/27/", target="_top"];
