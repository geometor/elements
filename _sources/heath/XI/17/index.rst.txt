...
.. figure:: XI.17.graphic.inverted.png
...
Now, since the two parallel planes KL, MN are cut by the plane EBDO, their common sections EO, BD are parallel. [:ref:`XI.16`]
...
And, since the straight line EO has been drawn parallel to BD, one of the sides of the triangle ABD, therefore, proportionally, as AE is to EB, so is AO to OD. [:ref:`VI.2`]
...
But it was also proved that, as AO is to OD, so is AE to EB; therefore also, as AE is to EB, so is CF to FD. [:ref:`V.11`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XI.17" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XI/17/", target="_top"];
