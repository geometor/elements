...
.. figure:: I.13.graphic.inverted.png
...
Now, if the angle ``CBA`` is equal to the angle ``ABD``, they are two right angles. [:ref:`I.def.10`]
...
.. graphviz::
   ...
   digraph {
     ...
     "I.13" [style="rounded,filled", fillcolor=lightblue, URL="/heath/I/13/", target="_top"];
