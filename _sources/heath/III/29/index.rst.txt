...
.. figure:: III.29.graphic.inverted.png
...
.. container:: center
   ...
   the angle ``BKC`` is also equal to the angle ``ELF``. [:ref:`III.27`]
...
.. container:: center
   ...
   the radii are also equal; therefore the two sides ``BK``, ``KC`` are equal to the two sides ``EL``, ``LF``; and they contain equal angles; therefore the base ``BC`` is equal to the base ``EF``. [:ref:`I.4`]
...
.. graphviz::
   ...
   digraph {
     ...
     "III.29" [style="rounded,filled", fillcolor=lightblue, URL="/heath/III/29/", target="_top"];
