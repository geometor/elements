...
.. figure:: III.34.graphic.inverted.png
...
Let ``EF`` be drawn touching ``ABC`` at the point ``B``, and on the straight line ``FB``, and at the point ``B`` on it, let the angle ``FBC`` be constructed equal to the angle at ``D``. [:ref:`I.23`]
...
.. graphviz::
   ...
   digraph {
     ...
     "III.34" [style="rounded,filled", fillcolor=lightblue, URL="/heath/III/34/", target="_top"];
     "I.11" -> "I.def.10";
     "I.13" -> "I.def.10";
     "III.31" -> "I.def.10";
     "I.13" -> "I.11";
