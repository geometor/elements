...
.. container:: center
   ...
   therefore ``AD`` touches the circle ``ABE``. [:ref:`III.16.p.1`]
...
Therefore the straight line ``AD`` touches the circle ``ABE``, because the angle at ``A`` is right. [:ref:`III.16.p.1`]
...
.. container:: center
   ...
   ``AD`` touches the circle ``AEB``. [:ref:`III.16.p.1`]
