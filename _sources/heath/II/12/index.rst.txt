...
.. figure:: II.12.graphic.inverted.png
...
But the square on ``CB`` is equal to the squares on ``CD``, ``DB``, for the angle at ``D`` is right; [:ref:`I.47`]


.. container:: center

   and the square on ``AB`` is equal to the squares on ``AD``, ``DB``; [:ref:`I.47`]
...
.. graphviz::
   ...
   digraph {
     ...
     "II.12" [style="rounded,filled", fillcolor=lightblue, URL="/heath/II/12/", target="_top"];
