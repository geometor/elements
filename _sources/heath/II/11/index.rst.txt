...
.. figure:: II.11.graphic.inverted.png
...
But the squares on ``BA``, ``AE`` are equal to the square on ``EB``, for the angle at ``A`` is right; [:ref:`I.47`]
...
.. graphviz::
   ...
   digraph {
     ...
     "II.11" [style="rounded,filled", fillcolor=lightblue, URL="/heath/II/11/", target="_top"];
