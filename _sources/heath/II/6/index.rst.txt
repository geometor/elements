...
.. container:: center
   ...
   Then, since ``AC`` is equal to ``CB``, ``AL`` is also equal to ``CH``. [:ref:`I.36`]


But ``CH`` is equal to ``HF``. [:ref:`I.43`]
...
.. graphviz::
   ...
   digraph {
     ...
     "II.6" [style="rounded,filled", fillcolor=lightblue, URL="/heath/II/6/", target="_top"];
...
:ref:`II.11`, :ref:`III.36`, :ref:`III.37`, :ref:`IV.10`, :ref:`IV.11`, :ref:`IV.12`, :ref:`X.110`, :ref:`X.28`, :ref:`X.75`, :ref:`X.81`, :ref:`X.93`, :ref:`X.99`