...
Then, since a straight line ``EF`` touches the circle ``ABCD`` at ``B``, and ``BA`` has been drawn from the point of contact at right angles to the tangent, the centre of the circle ``ABCD`` is on ``BA``. [:ref:`III.19`]
...
Therefore the remaining angles ``BAD``, ``ABD`` are equal to one right angle. [:ref:`I.32`]
...
Next, since ``ABCD`` is a quadrilateral in a circle, its opposite angles are equal to two right angles. [:ref:`III.22`]
...
.. graphviz::
   ...
   digraph {
     ...
     "III.32" [style="rounded,filled", fillcolor=lightblue, URL="/elements2/III/32/", target="_top"];
...
:ref:`III.33`, :ref:`III.34`, :ref:`IV.10`, :ref:`IV.11`, :ref:`IV.12`, :ref:`IV.2`