...
:excerpt: Triangles which are on equal bases and in the same parallels are equal to one another.

**Heath ID:** `I.38 <https://geometor.github.io/euclid/I/38/>`_
...
.. graphviz::
   ...
   digraph {
     ...
     "G.51" [label="G.51", penwidth=3, color="white", fillcolor="#555555", URL="/elements2/G.51/", target="_top"];
...
:ref:`G.53`, :ref:`G.55`, :ref:`G.57`, :ref:`G.58`
