...
Let a point *D* be taken at random on *AB*; let *AE* be cut off from *AC* equal to *AD*; [:ref:`I. 3 <elem.1.3>`] let *DE* be joined, and on *DE* let the equilateral triangle *DEF* be constructed; let *AF* be joined.
