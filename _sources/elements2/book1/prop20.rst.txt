...
Then, since *DA* is equal to *AC*, the angle *ADC* is also equal to the angle *ACD*; [:ref:`I. 5 <elem.1.5>`] therefore the angle BCD is greater than the angle ADC. [C.N. 5]
