...
For let *BC* be produced to *D*. [:ref:`Post. 2 <elem.1.post.2>`]

Then, since the angle *ACD* is an exterior angle of the triangle *ABC*,

it is greater than the interior and opposite angle *ABC*. [:ref:`I. 16 <elem.1.16>`] Let the angle ACB be added to each; therefore the angles *ACD*, *ACB* are greater than the angles *ABC*, *BCA*. *ACD*, *ACB* are equal to two right angles. [:ref:`I. 13 <elem.1.13>`]
