...
For, since *AC* is greater than *AB*, let *AD* be made equal to *AB* [:ref:`I. 3 <elem.1.3>`], and let *BD* bejoined.

Then, since the angle *ADB* is an exterior angle of the triangle *BCD*,

it is greater than the interior and opposite angle *DCB*. [:ref:`I. 16 <elem.1.16>`]
