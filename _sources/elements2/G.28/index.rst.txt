...
:original_id: I.19
:type: prop
:dependencies: G.27, G.12
:excerpt: In any triangle the greater angle is subtended by the greater side.

**Heath ID:** `I.19 <https://geometor.github.io/euclid/I/19/>`_
...
Now ``AC`` is not equal to ``AB``; for then the angle ``ABC`` would also have been equal to the angle ``ACB``; [:ref:`G.12`] but it is not; 
        therefore ``AC`` is not equal to ``AB``.

Neither is ``AC`` less than ``AB``, for then the angle ``ABC`` would also have been less than the angle ``ACB``; [:ref:`G.27`] but it is not; therefore ``AC`` is not less than ``AB``.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.28" [label="G.28", penwidth=3, color="white", fillcolor="#555555", URL="/elements2/G.28/", target="_top"];
...
:ref:`G.30`, :ref:`G.31`, :ref:`G.32`, :ref:`G.34`, :ref:`G.35`
