...
:original_id: X.62
:type: prop
:dependencies: g.167, g.343, g.358, g.381, g.383, g.417, g.415, g.405
...
Then, since AB is a second bimedial divided at C, therefore AC, CB are medial straight lines commensurable in square only and containing a medial rectangle, [:ref:`g.383`] so that the sum of the squares on AC, CB is also medial. [:ref:`g.415`]

And it is equal to DL; therefore DL is also medial.

And it is applied to the rational straight line DE; therefore MD is also rational and incommensurable in length with DE. [:ref:`g.358`]
...
And, since AC is incommensurable in length with CB, and, as AC is to CB, so is the square on AC to the rectangle AC, CB, therefore the square on AC is also incommensurable with the rectangle AC, CB. [:ref:`g.343`]

Hence the sum of the squares on AC, CB is incommensurable with twice the rectangle AC, CB, [:ref:`g.417`] that is, DL is incommensurable with MF, so that DM is also incommensurable with MG. [:ref:`g.167`, :ref:`g.343`]

And they are rational; therefore DG is binomial. [:ref:`g.381`]
...
Therefore DG is a third binomial straight line. [:ref:`g.405`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.418" [label="G.418", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.418/", target="_top"];
     ...
     "G.405" [label="G.405", style="rounded,filled", fillcolor=orange, URL="/elements2/g.405/", target="_top"];
     ...
     "G.417" [label="G.417", style="rounded,filled", fillcolor=orange, URL="/elements2/g.417/", target="_top"];
