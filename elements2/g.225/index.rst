...
Therefore also, as one of the antecedents is to one of the consequents, so will all the antecedents be to all the consequents; [:ref:`g.222`] therefore, as the unit BG is to the number EK, so is BC to EF.
