...
:original_id: XI.6
:type: prop
:dependencies: g.39, g.11, g.15, g.331, g.335, g.333
...
Now, since AB is at right angles to the plane of reference, it will also make right angles with all the straight lines which meet it and are in the plane of reference. [:ref:`g.333`]
...
But it is also at right angles to each of the straight lines BD, DC; therefore ED is set up at right angles to the three straight lines BD, DA, DC at their point of meeting; therefore the three straight lines BD, DA, DC are in one plane. [:ref:`g.335`]

But, in whatever plane DB, DA are, in that plane is AB also, for every triangle is in one plane; [:ref:`g.331`] therefore the straight lines AB, BD, DC are in one plane.
