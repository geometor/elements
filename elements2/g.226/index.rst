...
Therefore, alternately, the unit E measures the number B the same number of times that A measures C. [:ref:`g.225`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.226" [label="G.226", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.226/", target="_top"];
