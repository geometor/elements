...
:original_id: X.47
:type: prop
:dependencies: g.65, g.167, g.343, g.358, g.381, g.388
...
And it is applied to the rational straight line EF; therefore HE is rational and incommensurable in length with EF. [:ref:`g.358`
]

For the same reason HN is also rational and incommensurable in length with EF.

And, since the sum of the squares on AC, CB is incommensurable with twice the rectangle AC, CB, therefore EG is also incommensurable with GN, so that EH is also incommensurable with HN. [:ref:`g.167`
, :ref:`g.343`
]

And they are rational; therefore EH, HN are rational straight lines commensurable in square only; therefore EN is a binomial straight line divided at H. [:ref:`g.381`
]

Similarly we can prove that it is also divided at M.

And EH is not the same with MN; therefore a binomial has been divided at different points: which is absurd. [:ref:`g.388`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.394" [label="G.394", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.394/", target="_top"];
     ...
     "G.388" [label="G.388", URL="/elements2/g.388/", target="_top"];
