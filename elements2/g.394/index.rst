...
:original_id: XII.14
:type: prop
:dependencies: g.389, g.390, g.393
...
Since then the cylinders EB, CM are of the same height, they are to one another as their bases. [:ref:`g.390`]

But the bases are equal to one another; therefore the cylinders EB, CM are also equal.

And, since the cylinder FM has been cut by the plane CD which is parallel to its opposite planes, therefore, as the cylinder CM is to the cylinder FD, so is the axis LN to the axis KL. [:ref:`g.393`]
...
But, as the cylinder EB is to the cylinder FD, so is the cone ABG to the cone CDK. [:ref:`g.389`]
