...
:original_id: XI.35
:type: prop
:dependencies: g.36, g.11, g.60, g.61, g.15, g.338
...
But GL is perpendicular to the plane through BA, AC; therefore HK is also perpendicular to the plane through. BA, AC. [:ref:`g.338`]
...
Since the square on HA is equal to the squares on HK, KA, and the squares on KC, CA are equal to the square on KA, [:ref:`g.60`] therefore the square on HA is also equal to the squares on HK, KC, CA.

But the square on HC is equal to the squares on HK, KC; [:ref:`g.60`] therefore the square on HA is equal to the squares on HC, CA.

Therefore the angle HCA is right. [:ref:`g.61`]
...
Therefore MDF, HAC are two triangles which have two angles equal to two angles respectively, and one side equal to one side, namely, that subtending one of the equal angles, that is, HA equal to MD; therefore they will also have the remaining sides equal to the remaining sides respectively. [:ref:`g.36`]
...
But the angle CAB is also equal to the angle FDE; therefore the base BC is equal to the base EF, the triangle to the triangle, and the remaining angles to the remaining angles; [:ref:`g.11`] therefore the angle ACB is equal to the angle DFE.
...
Therefore BCK, EFN are two triangles which have two angles equal to two angles respectively, and one side equal to one side, namely, that adjacent to the equal angles, that is, BC equal to EF; therefore they will also have the remaining sides equal to the remaining sides. [:ref:`g.36`]
...
Therefore the base AK is equal to the base DN. [:ref:`g.11`]

And, since AH is equal to DM, the square on AH is also equal to the square on DM.

But the squares on AK, KH are equal to the square on AH, for the angle AKH is right; [:ref:`g.60`] and the squares on DN, NM are equal to the square on DM, for the angle DNM is right; [:ref:`g.60`] therefore the squares on AK, KH are equal to the squares on DN, NM; and of these the square on AK is equal to the square on DN; therefore the remaining square on KH is equal to the square on NM; therefore HK is equal to MN.

And, since the two sides HA, AK are equal to the two sides MD, DN respectively, and the base HK was proved equal to the base MN, therefore the angle HAK is equal to the angle MDN. [:ref:`g.15`]
