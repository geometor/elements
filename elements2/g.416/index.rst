...
:original_id: X.61
:type: prop
:dependencies: g.167, g.343, g.347, g.351, g.356, g.357, g.358, g.381, g.382, g.415, g.403
...
Then, since AB is a first bimedial divided at C, therefore AC, CB are medial straight lines commensurable in square only, and containing a rational rectangle, [:ref:`g.382`] so that the squares on AC, CB are also medial. [:ref:`g.357`]

Therefore DL is medial. [:ref:`g.415`]

And it has been applied to the rational straight line DE; therefore MD is rational and incommensurable in length with DE. [:ref:`g.358`]

Again, since twice the rectangle AC, CB is rational, MF is also rational.

And it is applied to the rational straight line ML; therefore MG is also rational and commensurable in length with ML, that is, DE; [:ref:`g.356`] therefore DM is incommensurable in length with MG. [:ref:`g.347`]
...
For, since the squares on AC, CB are greater than twice the rectangle AC, CB, therefore DL is also greater than MF, so that DM is also greater than MG. [:ref:`g.167`]
...
And the rectangle DK, KM is equal to the square on MN; therefore the square on DM is greater than the square on MG by the square on a straight line commensurable with DM. [:ref:`g.351`]

And MG is commensurable is length with DE.

Therefore DG is a second binomial straight line. [:ref:`g.403`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.416" [label="G.416", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.416/", target="_top"];
