...
For from the straight line AB let there be subtracted the straight line BC which is incommensurable in square with AB and fulfils the given conditions; [:ref:`g.377`] I say that the remainder AC is the irrational straight line aforesaid.

For, since the sum of the squares on AB, BC is medial, while twice the rectangle AB, BC is rational, therefore the squares on AB, BC are incommensurable with twice the rectangle AB, BC; therefore the remainder also, the square on AC, is incommensurable with twice the rectangle AB, BC. [:ref:`g.436`, X. 16]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.437" [label="G.437", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.437/", target="_top"];
...
:ref:`g.467`, :ref:`g.473`, :ref:`g.476`, :ref:`g.443`, :ref:`g.461`
