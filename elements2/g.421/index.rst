...
:original_id: X.65
:type: prop
:dependencies: g.167, g.343, g.358, g.381, g.387
...
Then, since AB is the side of the sum of two medial areas, divided at C, therefore AC, CB are straight lines incommensurable in square which make the sum of the squares on them medial, the rectangle contained by them medial, and moreover the sum of the squares on them incommensurable with the rectangle contained by them, [:ref:`g.387`]

so that, in accordance with what was before proved, each of the rectangles DL, MF is medial.

And they are applied to the rational straight line DE; therefore each of the straight lines DM, MG is rational and incommensurable in length with DE. [:ref:`g.358`]
...
Therefore DM is also incommensurable with MG; [:ref:`g.167`, :ref:`g.343`] therefore DM, MG are rational straight lines commensurable in square only; therefore DG is binomial. [:ref:`g.381`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.421" [label="G.421", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.421/", target="_top"];
