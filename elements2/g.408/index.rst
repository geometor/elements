...
:original_id: X.57
:type: prop
:dependencies: g.167, g.343, g.347, g.353, g.355, g.357, g.385, g.407
...
For, since AD is a fourth binomial straight line, therefore AE, ED are rational straight lines commensurable in square only, the square on AE is greater than the square on ED by the square on a straight line incommensurable with AE, and AE is commensurable in length with AB. [:ref:`g.407`]

Let DE be bisected at F, and let there be applied to AE a parallelogram, the rectangle AG, GE, equal to the square on EF; therefore AG is incommensurable in length with GE. [:ref:`g.353`]
...
Since AG is incommensurable with EG, AH is also incommensurable with GK, that is, SN with NQ; [:ref:`g.167`, :ref:`g.343`] therefore MN, NO are incommensurable in square.

And, since AE is commensurable with AB, AK is rational; [:ref:`g.355`] and it is equal to the squares on MN, NO; therefore the sum of the squares on MN, NO is also rational.

And, since DE is incommensurable in length with AB, that is, with EK, while DE is commensurable with EF, therefore EF is incommensurable in length with EK. [:ref:`g.347`]

Therefore EK, EF are rational straight lines commensurable in square only; therefore LE, that is, MR, is medial. [:ref:`g.357`]
...
But, if two straight lines incommensurable in square and making the sum of the squares on them rational, but the rectangle contained by them medial, be added together, the whole is irrational and is called major. [:ref:`g.385`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.408" [label="G.408", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.408/", target="_top"];
