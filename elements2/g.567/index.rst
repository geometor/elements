...
:original_id: XIII.9
:type: prop
:dependencies: g.45, g.12, g.205, g.170, g.566
...
But, as the circumference AC is to CB, so is the angle AEC to the angle CEB; [:ref:`g.205`] therefore the angle AEC is quadruple of the angle CEB.

And, since the angle EBC is equal to the angle ECB, [:ref:`g.12`] therefore the angle AEC is double of the angle ECB. [:ref:`g.45`]

And, since the straight line EC is equal to CD, for each of them is equal to the side of the hexagon inscribed in the circle ABC, [:ref:`g.566`] the angle CED is also equal to the angle CDE; [:ref:`g.12`] therefore the angle ECB is double of the angle EDC. [:ref:`g.45`]
...
But the angle EBD is common to the two triangles BEC and BED; therefore the remaining angle BED is also equal to the remaining angle ECB; [:ref:`g.45`] therefore the triangle EBD is equiangular with the triangle EBC.

Therefore, proportionally, as DB is to BE, so is EB to BC. [:ref:`g.170`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.567" [label="G.567", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.567/", target="_top"];
     ...
     "G.566" [label="G.566", style="rounded,filled", fillcolor=orange, URL="/elements2/g.566/", target="_top"];
     ...
     "G.205" [label="G.205", URL="/elements2/g.205/", target="_top"];
