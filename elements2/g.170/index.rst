...
:original_id: VI.4
:type: prop
:dependencies: g.26, g.39, g.47, g.41, g.159, g.163, g.168
...
Then, since the angles ``ABC``, ``ACB`` are less than two right angles, [:ref:`g.26`] and the angle ``ACB`` is equal to the angle ``DEC``, therefore the angles ``ABC``, ``DEC`` are less than two right angles; therefore ``BA``, ``ED``, when produced, will meet. [:ref:`g.41`]
...
.. container:: center
   ...
   ``AC`` is parallel to ``FE``. [:ref:`g.39`]


Therefore ``FACD`` is a parallelogram; therefore ``FA`` is equal to ``DC``, and ``AC`` to ``FD``. [:ref:`g.47`]

And, since ``AC`` has been drawn parallel to ``FE``, one side of the triangle ``FBE``, therefore, as ``BA`` is to ``AF``, so is ``BC`` to ``CE``. [:ref:`g.168`]
...
and alternately, as ``AB`` is to ``BC``, so is ``DC`` to ``CE``. [:ref:`g.159`]

Again, since ``CD`` is parallel to ``BF``, therefore, as ``BC`` is to ``CE``, so is ``FD`` to ``DE``. [:ref:`g.168`]
...
and alternately, as ``BC`` is to ``CA``, so is ``CE`` to ``ED``. [:ref:`g.159`]
...
and, as ``BC`` is to ``CA``, so is ``CE`` to ``ED``; therefore, ``ex aequali``, as ``BA`` is to ``AC``, so is ``CD`` to ``DE``. [:ref:`g.163`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.170" [label="G.170", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.170/", target="_top"];
...
:ref:`g.186`, :ref:`g.191`, :ref:`g.194`, :ref:`g.197`, :ref:`g.200`, :ref:`g.201`, :ref:`g.202`, :ref:`g.203`, :ref:`g.204`, :ref:`g.171`, :ref:`g.172`, :ref:`g.173`, :ref:`g.175`, :ref:`g.466`, :ref:`g.467`, :ref:`g.468`, :ref:`g.469`, :ref:`g.471`, :ref:`g.472`, :ref:`g.473`, :ref:`g.474`, :ref:`g.475`, :ref:`g.476`, :ref:`g.477`, :ref:`g.478`, :ref:`g.480`, :ref:`g.481`, :ref:`g.482`, :ref:`g.348`, :ref:`g.358`, :ref:`g.361`, :ref:`g.364`, :ref:`g.365`, :ref:`g.366`, :ref:`g.369`, :ref:`g.374`, :ref:`g.375`, :ref:`g.376`, :ref:`g.377`, :ref:`g.380`, :ref:`g.383`, :ref:`g.385`, :ref:`g.386`, :ref:`g.387`, :ref:`g.388`, :ref:`g.389`, :ref:`g.391`, :ref:`g.392`, :ref:`g.393`, :ref:`g.394`, :ref:`g.406`, :ref:`g.408`, :ref:`g.410`, :ref:`g.411`, :ref:`g.414`, :ref:`g.416`, :ref:`g.418`, :ref:`g.419`, :ref:`g.420`, :ref:`g.421`, :ref:`g.423`, :ref:`g.425`, :ref:`g.426`, :ref:`g.427`, :ref:`g.428`, :ref:`g.429`, :ref:`g.430`, :ref:`g.434`, :ref:`g.435`, :ref:`g.437`, :ref:`g.438`, :ref:`g.439`, :ref:`g.440`, :ref:`g.441`, :ref:`g.442`, :ref:`g.443`, :ref:`g.444`, :ref:`g.459`, :ref:`g.460`, :ref:`g.461`, :ref:`g.462`, :ref:`g.463`, :ref:`g.464`, :ref:`g.465`, :ref:`g.509`, :ref:`g.530`, :ref:`g.542`, :ref:`g.543`, :ref:`g.545`, :ref:`g.546`, :ref:`g.547`, :ref:`g.548`, :ref:`g.531`, :ref:`g.533`, :ref:`g.535`, :ref:`g.536`, :ref:`g.537`, :ref:`g.538`, :ref:`g.568`, :ref:`g.569`, :ref:`g.571`, :ref:`g.574`, :ref:`g.575`, :ref:`g.578`, :ref:`g.563`, :ref:`g.565`, :ref:`g.567`
