...
And, since DC is double of CA, while DC is equal to CK, and AC to CH, therefore KB is also double of BH. [:ref:`g.167`]
...
But, by hypothesis, the square on BA is also five times the square on CA; therefore the square on BA is equal to the squares on BC, CA: which is impossible. [:ref:`g.65`] 
...
.. graphviz::
   ...
   digraph {
     ...
     "G.558" [label="G.558", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.558/", target="_top"];
