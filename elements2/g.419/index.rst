...
:original_id: X.63
:type: prop
:dependencies: g.167, g.343, g.347, g.353, g.356, g.358, g.381, g.385, g.407
...
Then, since AB is a major straight line divided at C, AC, CB are straight lines incommensurable in square which make the sum of the squares on them rational, but the rectangle contained by them medial. [:ref:`g.385`]

Since then the sum of the squares on AC, CB is rational, therefore DL is rational; therefore DM is also rational and commensurable in length with DE. [:ref:`g.356`]

Again, since twice the rectangle AC, CB, that is, MF, is medial, and it is applied to the rational straight line ML, therefore MG is also rational and incommensurable in length with DE; [:ref:`g.358`] therefore DM is also incommensurable in length with MG. [:ref:`g.347`]

Therefore DM, MG are rational straight lines commensurable in square only; therefore DG is binomial. [:ref:`g.381`]
...
Therefore DG is a fourth binomial straight line. [:ref:`g.407`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.419" [label="G.419", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.419/", target="_top"];
