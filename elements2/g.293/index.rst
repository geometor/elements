...
:original_id: IX.9
:type: prop
:dependencies: g.286, g.292, g.278, g.279
...
Now it has been proved that B, the third from the unit, is square, as are also all those which leave out one; [:ref:`g.292`] I say that all the rest are also square.

For, since A, B, C are in continued proportion, and A is square, therefore C is also square. [:ref:`g.278`]

Again, since B, C, D are in continued proportion, and B is square, D is also square. [:ref:`g.278`]

Similarly we can prove that all the rest are also square.

Next, let A be cube; I say that all the rest are also cube.

Now it has been proved that C, the fourth from the unit, is cube, as also are all those which leave out two; [:ref:`g.292`] I say that all the rest are also cube.
...
But, if a cube number by multiplying itself make some number, the product is cube. [:ref:`g.286`]

Therefore B is also cube.

And, since the four numbers A, B, C, D are in continued proportion, and A is cube, D also is cube. [:ref:`g.279`]
