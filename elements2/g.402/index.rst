...
:original_id: X.54
:type: prop
:dependencies: g.75, g.167, g.185, g.343, g.346, g.347, g.349, g.351, g.355, g.381, g.354, g.401
...
For let the area AC be contained by the rational straight line AB and the first binomial AD; I say that the side
...
It is then manifest that AE, ED are rational straight lines commensurable in square only, the square on AE is greater than the square on ED by the square on a straight line commensurable with AE, and AE is commensurable in length with the rational straight line AB set out. [:ref:`g.401`]
...
Let GH, EK, FL be drawn from G, E, F parallel to either of the straight lines AB, CD; let the square SN be constructed equal to the parallelogram AH, and the square NQ equal to GK, [:ref:`g.75`] and let them be placed so that MN is in a straight line with NO; therefore RN is also in a straight line with NP.

And let the parallelogram SQ be completed; therefore SQ is a square. [Lemma]

Now, since the rectangle AG, GE is equal to the square on EF, therefore, as AG is to EF, so is FE to EG; [:ref:`g.185`] therefore also, as AH is to EL, so is EL to KG; [:ref:`g.167`] therefore EL is a mean proportional between AH, GK.
...
But AH, GK are also equal to SN, NQ; therefore the whole AC is equal to the whole SQ, that is, to the square on MO; therefore MO is the side
of AC.

I say next that MO is binomial.

For, since AG is commensurable with GE, therefore AE is also commensurable with each of the straight lines AG, GE. [:ref:`g.349`]

But AE is also, by hypothesis, commensurable with AB; therefore AG, GE are also commensurable with AB. [:ref:`g.346`]

And AB is rational; therefore each of the straight lines AG, GE is also rational; therefore each of the rectangles AH, GK is rational, [:ref:`g.355`] and AH is commensurable with GK.

But AH is equal to SN, and GK to NQ; therefore SN, NQ, that is, the squares on MN, NO, are rational and commensurable.

And, since AE is incommensurable in length with ED, while AE is commensurable with AG, and DE is commensurable with EF, therefore AG is also incommensurable with EF, [:ref:`g.347`] so that AH is also incommensurable with EL. [:ref:`g.167`, :ref:`g.343`]

But AH is equal to SN, and EL to MR; therefore SN is also incommensurable with MR.

But, as SN is to MR, so is PN to NR; [:ref:`g.167`] therefore PN is incommensurable with NR. [:ref:`g.343`]
...
Therefore MO is binomial [:ref:`g.381`] and the side
of AC. Q. E. D.
2. side.
I use the word side
in the sense explained in the note on :ref:`g.354` (P. 13 above), i.e. as short for side of a square equal to.
The Greek is ἡ τὸ χωίον δυναμένη.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.402" [label="G.402", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.402/", target="_top"];
