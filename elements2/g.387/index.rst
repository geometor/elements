...
:original_id: X.41
:type: prop
:dependencies: g.65, g.66, g.167, g.343, g.358, g.380, g.381, g.354
...
For let two straight lines AB, BC incommensurable in square and satisfying the given conditions [:ref:`g.380`
] be added together; I say that AC is irrational.

Let a rational straight line DE be set out, and let there be applied to DE the rectangle DF equal to the squares on AB, BC, and the rectangle GH equal to twice the rectangle AB, BC; therefore the whole DH is equal to the square on AC. [:ref:`g.65`
]

Now, since the sum of the squares on AB, BC is medial, and is equal to DF, therefore DF is also medial.

And it is applied to the rational straight line DE; therefore DG is rational and incommensurable in length with DE. [:ref:`g.358`
]

For the same reason GK is also rational and incommensurable in length with GF, that is, DE.

And, since the squares on AB, BC are incommensurable with twice the rectangle AB, BC, DF is incommensurable with GH; so that DG is also incommensurable with GK. [:ref:`g.167`
, :ref:`g.343`
]

And they are rational; therefore DG, GK are rational straight lines commensurable in square only; therefore DK is irrational and what is called binomial. [:ref:`g.381`
]

But DE is rational; therefore DH is irrational, and the side of the square which is equal to it is irrational. [:ref:`g.354`
]
...
And, since the rectangle AC, CB together with the square on EC is equal to the square on EB, [:ref:`g.66`
...
.. graphviz::
   ...
   digraph {
     ...
     "G.387" [label="G.387", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.387/", target="_top"];
...
:ref:`g.411`, :ref:`g.421`, :ref:`g.428`, :ref:`g.430`
