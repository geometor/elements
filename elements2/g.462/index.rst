...
:original_id: X.96
:type: prop
:dependencies: g.167, g.198, g.343, g.353, g.357, g.438, g.455
...
For let DG be the annex to AD; therefore AG, GD are rational straight lines commensurable in square only, neither of them is commensurable in length with the rational straight line AC set out, and the square on the whole AG is greater than the square on the annex DG by the square on a straight line incommensurable in length with AG. [:ref:`g.455`]

Since then the square on AG is greater than the square on GD by the square on a straight line incommensurable in length with AG, therefore, if there be applied to AG a parallelogram equal to the fourth part of the square on DG and deficient by a square figure, it will divide it into incommensurable parts. [:ref:`g.353`]
...
But, as AF is to FG, so is AI to FK. [:ref:`g.167`] therefore AI is incommensurable with FK. [:ref:`g.343`]

And, since AG, AC are rational straight lines commensurable in square only, AK is medial. [:ref:`g.357`]

Again, since AC, DG are rational straight lines and incommensurable in length, DK is also medial. [:ref:`g.357`]

Now, since AG, GD are commensurable in square only, therefore AG is incommensurable in length with GD.

But, as AG is to GD, so is AK to KD; [:ref:`g.167`] therefore AK is incommensurable with KD. [:ref:`g.343`]

Now let the square LM be constructed equal to AI, and let NO equal to FK, and about the same angle, be subtracted; therefore the squares LM, NO are about the same diameter. [:ref:`g.198`]
...
Therefore LN is the irrational straight line called that which produces with a medial area a medial whole; [:ref:`g.438`] and it is the side
of the area AB.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.380" [label="G.380", URL="/elements2/g.380/", target="_top"];
     ...
     "G.438" [label="G.438", URL="/elements2/g.438/", target="_top"];
     ...
     "G.462" [label="G.462", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.462/", target="_top"];
     ...
     "G.175" [label="G.175", URL="/elements2/g.175/", target="_top"];
     ...
     "G.379" [label="G.379", style="rounded,filled", fillcolor=orange, URL="/elements2/g.379/", target="_top"];
     ...
     "G.375" [label="G.375", URL="/elements2/g.375/", target="_top"];
     ...
     "G.378" [label="G.378", style="rounded,filled", fillcolor=orange, URL="/elements2/g.378/", target="_top"];
