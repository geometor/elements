...
For let BE be the annex to AB, and let the same construction be made; therefore AE, EB are straight lines incommensurable in square which make the sum of the squares on them medial, the rectangle contained by them medial, and further the sum of the squares on them incommensurable with the rectangle contained by them. [:ref:`g.438`]
...
Therefore CD is a straight line which produces with a medial area a medial whole. [:ref:`g.438`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.474" [label="G.474", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.474/", target="_top"];
