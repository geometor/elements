...
:original_id: XIII.5
:type: prop
:dependencies: g.153, g.185, g.408
...
Since AB has been cut in extreme and mean ratio at C, therefore the rectangle AB, BC is equal to the square on AC. [:ref:`g.408`, VI. 17]
...
Therefore, as DB is to BA, so is BA to AD. [:ref:`g.185`]

And DB is greater than BA; therefore BA is also greater than AD. [:ref:`g.153`]
