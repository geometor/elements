...
:original_id: X.67
:type: prop
:dependencies: g.150, g.159, g.162, g.343, g.361, g.382, g.383, g.362, g.424
...
For, since AB is bimedial, let it be divided into its medials at E; therefore AE, EB are medial straight lines commensurable in square only. [:ref:`g.424`]

And let it be contrived that, as AB is to CD, so is AE to CF; therefore also the remainder EB is to the remainder FD as AB is to CD. [:ref:`g.162`]

But AB is commensurable in length with CD; therefore AE, EB are also commensurable with CF, FD respectively. [:ref:`g.343`]

But AE, EB are medial; therefore CF, FD are also medial. [:ref:`g.361`]

And since, as AE is to EB, so is CF to FD, [:ref:`g.150`] and AE, EB are commensurable in square only, CF, FD are also commensurable in square only. [:ref:`g.343`]

But they were also proved medial; therefore CD is bimedial.

I say next that it is also the same in order with AB.

For since, as AE is to EB, so is CF to FD, therefore also, as the square on AE is to the rectangle AE, EB, so is the square on CF to the rectangle CF, FD; therefore, alternately, as the square on AE is to the square on CF, so is the rectangle AE, EB to the rectangle CF, FD. [:ref:`g.159`]
...
If therefore the rectangle AE, EB is rational, the rectangle CF, FD is also rational, [and for this reason CD is a first bimedial]; [:ref:`g.382`] but if medial, medial, [:ref:`g.362`] and each of the straight lines AB, CD is a second bimedial. [:ref:`g.383`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.424" [label="G.424", style="rounded,filled", fillcolor=orange, URL="/elements2/g.424/", target="_top"];
     "G.208" [label="G.208", URL="/elements2/g.208/", target="_top"];
     "G.163" [label="G.163", URL="/elements2/g.163/", target="_top"];
     "G.425" [label="G.425", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.425/", target="_top"];
