...
:original_id: X.38
:type: prop
:dependencies: g.57, g.65, g.167, g.343, g.347, g.349, g.356, g.358, g.381, g.338, g.354
...
For let a rational straight line DE be set out, and let the parallelogram DF equal to the square on AC be applied to DE, producing DG as breadth. [:ref:`g.57`
]

Then, since the square on AC is equal to the squares on AB, BC and twice the rectangle AB, BC, [:ref:`g.65`
...
And they are applied to the rational straight line DE; therefore each of the straight lines DH, HG is rational and incommensurable in length with DE. [:ref:`g.358`
]

Since then AB is incommensurable in length with BC, and, as AB is to BC, so is the square on AB to the rectangle AB, BC, therefore the square on AB is incommensurable with the rectangle AB, BC. [:ref:`g.343`
]

But the sum of the squares on AB, BC is commensurable with the square on AB, [:ref:`g.349`
] and twice the rectangle AB, BC is commensurable with the rectangle AB, BC. [:ref:`g.338`
]

Therefore the sum of the squares on AB, BC is incommensurable with twice the rectangle AB, BC. [:ref:`g.347`
]

But EH is equal to the squares on AB, BC, and HF is equal to twice the rectangle AB, BC.

Therefore EH is incommensurable with HF, so that DH is also incommensurable in length with HG. [:ref:`g.167`
, :ref:`g.343`
]

Therefore DH, HG are rational straight lines commensurable in square only; so that DG is irrational. [:ref:`g.381`
]

But DE is rational; and the rectangle contained by an irrational and a rational straight line is irrational; [cf. :ref:`g.356`
] therefore the area DF is irrational, and the side of the square equal to it is irrational. [:ref:`g.354`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.383" [label="G.383", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.383/", target="_top"];
...
:ref:`g.391`, :ref:`g.406`, :ref:`g.418`, :ref:`g.425`, :ref:`g.430`
