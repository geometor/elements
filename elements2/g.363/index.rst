...
:original_id: X.24
:type: prop
:dependencies: g.167, g.343, g.362
...
And, since AB is commensurable in length with BC, while AB is equal to BD, therefore DB is also commensurable in length with BC; so that DA is also commensurable with AC. [:ref:`g.167`, :ref:`g.343`]

But DA is medial; therefore AC is also medial. [:ref:`g.362`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.363" [label="G.363", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.363/", target="_top"];
