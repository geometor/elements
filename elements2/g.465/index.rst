...
:original_id: X.99
:type: prop
:dependencies: g.68, g.150, g.167, g.343, g.347, g.351, g.358, g.432, g.434, g.415, g.449
...
For let BG be the annex to AB; therefore AG, GB are medial straight lines commensurable in square only which contain a medial rectangle. [:ref:`g.434`]

Let CH equal to the square on AG be applied to CD, producing CK as breadth, and let KL equal to the square on BG be applied to KH, producing KM as breadth; therefore the whole CL is equal to the squares on AG, GB; therefore CL is also medial. [:ref:`g.415`]

And it is applied to the rational straight line CD, producing CM as breadth; therefore CM is rational and incommensurable in length with CD. [:ref:`g.358`]

Now, since the whole CL is equal to the squares on AG, GB, and, in these, CE is equal to the square on AB, therefore the remainder LF is equal to twice the rectangle AG, GB. [:ref:`g.68`]
...
And it is applied to the rational straight line EF, producing FM as breadth; therefore FM is also rational and incommensurable in length with CD. [:ref:`g.358`]

And, since AG, GB are commensurable in square only, therefore AG is incommensurable in length with GB; therefore the square on AG is also incommensurable with the rectangle AG, GB. [:ref:`g.167`, :ref:`g.343`]

But the squares on AG, GB are commensurable with the square on AG, and twice the rectangle AG, GB with the rectangle AG, GB; therefore the squares on AG, GB are incommensurable with twice the rectangle AG, GB. [:ref:`g.347`]
...
But, as CL is to FL, so is CM to FM; [:ref:`g.167`] therefore CM is incommensurable in length with FM. [:ref:`g.343`]

And both are rational; therefore CM, MF are rational straight lines commensurable in square only; therefore CF is an apotome. [:ref:`g.432`]

I say next that it is also a third apotome.

For, since the square on AG is commensurable with the square on GB, therefore CH is also commensurable with KL, so that CK is also commensurable with KM. [:ref:`g.167`, :ref:`g.343`]
...
But, as CH is to NL, so is CK to NM, and, as NL is to KL, so is NM to KM; [:ref:`g.167`] therefore, as CK is to MN, so is MN to KM; [:ref:`g.150`] therefore the rectangle CK, KM is equal to [the square on MN, that is, to] the fourth part of the square on FM.
...
And neither of the straight lines CM, MF is commensurable in length with the rational straight line CD set out; therefore CF is a third apotome. [:ref:`g.449`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.465" [label="G.465", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.465/", target="_top"];
