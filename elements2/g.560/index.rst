...
Since then AB has been cut in extreme and mean ratio at C, and AC is the greater segment, therefore the rectangle AB, BC is equal to the square on AC. [:ref:`g.556`, :ref:`g.185`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.560" [label="G.560", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.560/", target="_top"];
     ...
     "G.556" [label="G.556", style="rounded,filled", fillcolor=orange, URL="/elements2/g.556/", target="_top"];
