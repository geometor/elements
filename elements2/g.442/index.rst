...
therefore AC, CB are straight lines incommensurable in square which make the sum of the squares on them rational, but twice the rectangle contained by them medial. [:ref:`g.435`]

I say that no other straight line can be annexed to AB fulfilling the same conditions.

For, if possible, let BD be so annexed; therefore AD, DB are also straight lines incommensurable in square which fulfil the aforesaid conditions. [:ref:`g.435`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.442" [label="G.442", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.442/", target="_top"];
