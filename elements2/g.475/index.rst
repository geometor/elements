...
:original_id: X.108
:type: prop
:dependencies: g.347, g.356, g.358, g.432, g.457, g.460, g.445, g.451
...
And they are applied to the rational straight line FG; therefore FH is rational and commensurable in length with FG, [:ref:`g.356`] while FK is rational and incommensurable in length with FG; [:ref:`g.358`] therefore FH is incommensurable in length with FK. [:ref:`g.347`]

Therefore FH, FK are rational straight lines commensurable in square only; therefore KH is an apotome [:ref:`g.432`], and KF the annex to it.
...
Now the whole HF is commensurable in length with the rational straight line FG set out; therefore KH is a first apotome. [:ref:`g.445`]

But the side
of the rectangle contained by a rational straight line and a first apotome is an apotome. [:ref:`g.457`]

Therefore the side
of LH, that is, of EC, is an apotome.

But, if the square on HF is greater than the square on FK by the square on a straight line incommensurable with HF, while the whole FH is commensurable in length with the rational straight line FG set out, KH is a fourth apotome. [:ref:`g.451`]

But the side
of the rectangle contained by a rational straight line and a fourth apotome is minor. [:ref:`g.460`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.457" [label="G.457", URL="/elements2/g.457/", target="_top"];
     ...
     "G.460" [label="G.460", URL="/elements2/g.460/", target="_top"];
     ...
     "G.475" [label="G.475", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.475/", target="_top"];
