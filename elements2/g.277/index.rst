...
:original_id: VIII.21
:type: prop
:dependencies: g.224, g.228, g.230, g.231, g.244, g.252, g.276, g.254
...
For let three numbers E, F, G, the least of those which have the same ratio with A, C, D, be taken; [:ref:`g.244` or :ref:`g.252`] therefore the extremes of them E, G are prime to one another. [:ref:`g.254`]

Now, since one mean proportional number F has fallen between E, G, therefore E, G are similar plane numbers. [:ref:`g.276`]
...
Now, since E, F, G are the least of the numbers which have the same ratio with A, C, D, and the multitude of the numbers E, F, G is equal to the multitude of the numbers A, C, D, therefore, ex aequali, as E is to G, so is A to D. [:ref:`g.224`]

But E, G are prime, primes are also least, [:ref:`g.231`] and the least measure those which have the same ratio with them the same number of times, the greater the greater and the less the less, that is, the antecedent the antecedent and the consequent the consequent; [:ref:`g.230`] therefore E measures A the same number of times that G measures D.
...
For since N, O by multiplying E have made A, C, therefore, as N is to O, so is A to C, that is, E to F. [:ref:`g.228`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.277" [label="G.277", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.277/", target="_top"];
...
:ref:`g.294`, :ref:`g.298`, :ref:`g.299`, :ref:`g.286`, :ref:`g.322`, :ref:`g.329`, :ref:`g.287`, :ref:`g.288`, :ref:`g.289`, :ref:`g.292`, :ref:`g.293`, :ref:`g.279`, :ref:`g.281`
