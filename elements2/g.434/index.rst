...
:original_id: X.75
:type: prop
:dependencies: g.68, g.167, g.343, g.347, g.349, g.356, g.358, g.369, g.338, g.432, g.415, g.362
...
For from the medial straight line AB let there be subtracted the medial straight line CB which is commensurable with the whole AB in square only and such that the rectangle AB, BC, which it contains with the whole AB, is medial; [:ref:`g.369`] I say that the remainder AC is irrational; and let it be called a second apotome of a medial straight line.

For let a rational straight line DI be set out, let DE equal to the squares on AB, BC be applied to DI, producing DG as breadth, and let DH equal to twice the rectangle AB, BC be applied to DI, producing DF as breadth; therefore the remainder FE is equal to the square on AC. [:ref:`g.68`]

Now, since the squares on AB, BC are medial and commensurable, therefore DE is also medial. [:ref:`g.415`]

And it is applied to the rational straight line DI, producing DG as breadth; therefore DG is rational and incommensurable in length with DI. [:ref:`g.358`]

Again, since the rectangle AB, BC is medial, therefore twice the rectangle AB, BC is also medial. [:ref:`g.362`]

And it is equal to DH; therefore DH is also medial.

And it has been applied to the rational straight line DI, producing DF as breadth; therefore DF is rational and incommensurable in length with DI. [:ref:`g.358`]

And, since AB, BC are commensurable in square only, therefore AB is incommensurable in length with BC; therefore the square on AB is also incommensurable with the rectangle AB, BC. [:ref:`g.343`]

But the squares on AB, BC are commensurable with the square on AB, [:ref:`g.349`] and twice the rectangle AB, BC is commensurable with the rectangle AB, BC; [:ref:`g.338`] therefore twice the rectangle AB, BC is incommensurable with the squares on AB, BC. [:ref:`g.347`]

But DE is equal to the squares on AB, BC, and DH to twice the rectangle AB, BC; therefore DE is incommensurable with DH.

But, as DE is to DH, so is GD to DF; [:ref:`g.167`] therefore GD is incommensurable with DF. [:ref:`g.343`]

And both are rational; therefore GD, DF are rational straight lines commensurable in square only; therefore FG is an apotome. [:ref:`g.432`]

But DI is rational, and the rectangle contained by a rational and an irrational straight line is irrational, [deduction from :ref:`g.356`] and its ’side’ is irrational.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.434" [label="G.434", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.434/", target="_top"];
...
:ref:`g.477`, :ref:`g.441`, :ref:`g.459`, :ref:`g.465`
