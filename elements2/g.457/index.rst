...
:original_id: X.91
:type: prop
:dependencies: g.150, g.167, g.185, g.198, g.343, g.346, g.347, g.349, g.351, g.355, g.357, g.432, g.412, g.445
...
For, since AD is a first apotome, let DG be its annex; therefore AG, GD are rational straight lines commensurable in square only. [:ref:`g.432`]

And the whole AG is commensurable with the rational straight line AC set out, and the square on AG is greater than the square on GD by the square on a straight line commensurable in length with AG; [:ref:`g.445`] if therefore there be applied to AG a parallelogram equal to the fourth part of the square on DG and deficient by a square figure, it divides it into commensurable parts. [:ref:`g.351`]
...
Now, since AF is commensurable in length with FG, therefore AG is also commensurable in length with each of the straight lines AF, FG. [:ref:`g.349`]

But AG is commensurable with AC; therefore each of the straight lines AF, FG is commensurable in length with AC. [:ref:`g.346`]

And AC is rational; therefore each of the straight lines AF, FG is also rational, so that each of the rectangles AI, FK is also rational. [:ref:`g.355`]

Now, since DE is commensurable in length with EG, therefore DG is also commensurable in length with each of the straight lines DE, EG. [:ref:`g.349`]

But DG is rational and incommensurable in length with AC; therefore each of the straight lines DE, EG is also rational and incommensurable in length with AC; [:ref:`g.347`] therefore each of the rectangles DH, EK is medial. [:ref:`g.357`]

Now let the square LM be made equal to AI, and let there be subtracted the square NO having a common angle with it, the angle LPM, and equal to FK; therefore the squares LM, NO are about the same diameter. [:ref:`g.198`]

Let PR be their diameter, and let the figure be drawn.

Since then the rectangle contained by AF, FG is equal to the square on EG, therefore, as AF is to EG, so is EG to FG. [:ref:`g.185`]

But, as AF is to EG, so is AI to EK, and, as EG is to FG, so is EK to KF; [:ref:`g.167`] therefore EK is a mean proportional between AI, KF. [:ref:`g.150`]

But MN is also a mean proportional between LM, NO, as was before proved, [:ref:`g.412`] and AI is equal to the square LM, and KF to NO; therefore MN is also equal to EK.
...
But, as LO is to NO, so is LP to PN; [:ref:`g.167`] therefore LP is incommensurable in length with PN. [:ref:`g.343`]

And both are rational; therefore LP, PN are rational straight lines commensurable in square only; therefore LN is an apotome. [:ref:`g.432`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.457" [label="G.457", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.457/", target="_top"];
