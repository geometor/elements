...
:original_id: X.58
:type: prop
:dependencies: g.167, g.343, g.346, g.347, g.353, g.355, g.357, g.386, g.409
...
For, since AG is incommensurable with GE, [:ref:`g.353`] therefore AH is also commensurable with HE, [:ref:`g.167`, :ref:`g.343`] that is, the square on MN with the square on NO; therefore MN, NO are incommensurable in square.

And, since AD is a fifth binomial straight line, and ED the lesser segment, therefore ED is commensurable in length with AB. [:ref:`g.409`]

But AE is incommensurable with ED; therefore AB is also incommensurable in length with AE. [:ref:`g.347`]

Therefore AK, that is, the sum of the squares on MN, NO, is medial. [:ref:`g.357`]

And, since DE is commensurable in length with AB, that is, with EK, while DE is commensurable with EF, therefore EF is also commensurable with EK. [:ref:`g.346`]

And EK is rational; therefore EL, that is, MR, that is, the rectangle MN, NO, is also rational. [:ref:`g.355`]
...
Therefore MO is the side of a rational plus a medial area [:ref:`g.386`] and is the side
...
.. graphviz::
   ...
   digraph {
     ...
     "G.410" [label="G.410", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.410/", target="_top"];
