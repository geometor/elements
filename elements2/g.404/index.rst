...
:original_id: XIII.1
:type: prop
:dependencies: g.167, g.185, g.403
...
Now, since AB has been cut in extreme and mean ratio at C, therefore the rectangle AB, BC is equal to the square on AC. [:ref:`g.403`, :ref:`g.185`]
...
But, as KA is to AH, so is CK to CH; [:ref:`g.167`] therefore CK is double of CH.
