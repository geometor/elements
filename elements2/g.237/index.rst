...
For, since each of the numbers A, B is prime to C, therefore the product of A, B will also be prime to C. [:ref:`g.235`]
...
Therefore the product of C, D will also be prime to E. [:ref:`g.235`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.237" [label="G.237", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.237/", target="_top"];
     "G.235" -> "G.234";
     "G.211" -> "G.208";
     "G.144" -> "G.140";
     "G.229" -> "G.144";
