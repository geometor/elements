...
:original_id: X.17
:type: None
:dependencies: g.66, g.423, g.417, g.411
...
And, since the straight line BC has been cut into equal parts at E, and into unequal parts at D, therefore the rectangle contained by BD, DC, together with the square on ED, is equal to the square on EC; [:ref:`g.66`]
...
But CD is commensurable in length with CD, BF, for CD is equal to BF. [:ref:`g.411`]

Therefore BC is also commensurable in length with BF, CD, [:ref:`g.423`] so that BC is also commensurable in length with the remainder FD; [:ref:`g.417`] therefore the square on BC is greater than the square on A by the square on a straight line commensurable with BC.
...
Therefore BC is commensurable in length with FD, so that BC is also commensurable in length with the remainder, the sum of BF, DC. [:ref:`g.417`]

But the sum of BF, DC is commensurable with DC, [:ref:`g.411`] so that BC is also commensurable in length with CD; [:ref:`g.423`] and therefore, separando, BD is commensurable in length with DC. [:ref:`g.417`]
