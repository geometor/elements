...
:original_id: X.112
:type: prop
:dependencies: g.150, g.151, g.153, g.159, g.160, g.188, g.184, g.194, g.343, g.346, g.348, g.349, g.356, g.381, g.432, g.479
...
Since then the rectangle BC, EF is equal to the rectangle BD, G, therefore, as CB is to BD, so is G to EF. [:ref:`g.184`]

But CB is greater than BD; therefore G is also greater than EF. [:ref:`g.159`, :ref:`g.153`]

Let EH be equal to G; therefore, as CB is to BD, so is HE to EF; therefore, separando, as CD is to BD, so is HF to FE. [:ref:`g.160`]

Let it be contrived that, as HF is to FE, so is FK to KE; therefore also the whole HK is to the whole KF as FK is to KE; for, as one of the antecedents is to one of the consequents, so are all the antecedents to all the consequents. [:ref:`g.151`]

But, as FK is to KE, so is CD to DB; [:ref:`g.150`] therefore also, as HK is to KF, so is CD to DB. [id.]

But the square on CD is commensurable with the square on DB; [:ref:`g.381`] therefore the square on HK is also commensurable with the square on KF. [:ref:`g.194`, :ref:`g.343`]

And, as the square on HK is to the square on KF, so is HK to KE, since the three straight lines HK, KF, KE are proportional. [:ref:`g.188`]

Therefore HK is commensurable in length with KE, so that HE is also commensurable in length with EK. [:ref:`g.349`]
...
And it is applied to the rational straight line BD; therefore EH is rational and commensurable in length with BD; [:ref:`g.356`] so that EK, being commensurable with it, is also rational and commensurable in length with BD.

Since, then, as CD is to DB, so is FK to KE, while CD, DB are straight lines commensurable in square only, therefore FK, KE are also commensurable in square only. [:ref:`g.343`]

But KE is rational; therefore FK is also rational.

Therefore FK, KE are rational straight lines commensurable in square only; therefore EF is an apotome. [:ref:`g.432`]
...
If then the square on CD is greater than the square on DB by the square on a straight line commensurable with CD, the square on FK is also greater than the square on KE by the square on a straight line commensurable with FK. [:ref:`g.348`]

And, if CD is commensurable in length with the rational straight line set out, so also is FK; [:ref:`g.479`] if BD is so commensurable, so also is KE; [:ref:`g.346`] but, if neither of the straight lines CD, DB is so commensurable, neither of the straight lines FK, KE is so.

But, if the square on CD is greater than the square on DB by the square on a straight line incommensurable with CD, the square on FK is also greater than the square on KE by the square on a straight line incommensurable with FK. [:ref:`g.348`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.480" [label="G.480", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.480/", target="_top"];
     ...
     "G.479" [label="G.479", style="rounded,filled", fillcolor=orange, URL="/elements2/g.479/", target="_top"];
