...
:original_id: XII.18
:type: prop
:dependencies: g.159, g.553, g.554, g.534
...
But, inasmuch as LMN is greater than DEF, therefore, as the sphere LMN is to the sphere ABC, so is the sphere DEF to some less sphere than the sphere ABC, as was before proved. [:ref:`g.534`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.554" [label="G.554", style="rounded,filled", fillcolor=orange, URL="/elements2/g.554/", target="_top"];
     ...
     "G.504" [label="G.504", URL="/elements2/g.504/", target="_top"];
     ...
     "G.551" [label="G.551", style="rounded,filled", fillcolor=orange, URL="/elements2/g.551/", target="_top"];
     ...
     "G.553" [label="G.553", URL="/elements2/g.553/", target="_top"];
     ...
     "G.550" [label="G.550", style="rounded,filled", fillcolor=orange, URL="/elements2/g.550/", target="_top"];
     "G.45" [label="G.45", URL="/elements2/g.45/", target="_top"];
     "G.555" [label="G.555", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.555/", target="_top"];
     ...
     "G.552" [label="G.552", style="rounded,filled", fillcolor=orange, URL="/elements2/g.552/", target="_top"];
