...
:original_id: XII.17
:type: prop
:dependencies: g.36, g.46, g.60, g.108, g.112, g.151, g.168, g.341, g.350, g.331, g.336, g.337, g.339, g.397, g.333, g.349, g.398, g.399
...
Now, since OA is at right angles to the plane of the circle BCDE, therefore all the planes through OA are also at right angles to the plane of the circle BCDE; [:ref:`g.350`] hence the semicircles BOD, KON are also at right angles to the plane of the circle BCDE.
...
Let them be inscribed, and let them be BP, PQ, QR, RO and KS, ST, TU, UO, let SP, TQ, UR be joined, and from P, S let perpendiculars be drawn to the plane of the circle BCDE; [:ref:`g.341`] these will fall on BD, KN, the common sections of the planes, inasmuch as the planes of BOD, KON are also at right angles to the plane of the circle BCDE. [cf. :ref:`g.349`]

Let them so fall, and let them be PV, SW, and let WV be joined.

Now since, in the equal semicircles BOD, KON, equal straight lines BP, KS have been cut off, and the perpendiculars PV, SW have been drawn, therefore PV is equal to SW, and BV to KW. [:ref:`g.108`, :ref:`g.36`]

But the whole BA is also equal to the whole KA; therefore the remainder VA is also equal to the remainder WA; therefore, as BV is to VA, so is KW to WA; therefore WV is parallel to KB. [:ref:`g.168`]

And, since each of the straight lines PV, SW is at right angles to the plane of the circle BCDE, therefore PV is parallel to SW. [:ref:`g.336`]

But it was also proved equal to it; therefore WV, SP are also equal and parallel. [:ref:`g.46`]

And, since WV is parallel to SP, while WV is parallel to KB, therefore SP is also parallel to KB. [:ref:`g.339`]

And BP, KS join their extremities; therefore the quadrilateral KBPS is in one plane, inasmuch as, if two straight lines be parallel, and points be taken at random on each of them, the straight line joining the points is in the same plane with the parallels. [:ref:`g.337`]

For the same reason each of the quadrilaterals SPQT, TQRU is also in one plane.

But the triangle URO is also in one plane. [:ref:`g.331`]
...
Let AX be drawn from the point A perpendicular to the plane of the quadrilateral KBPS, and let it meet the plane at the point X; [:ref:`g.341`] let XB, XK be joined.

Then, since AX is at right angles to the plane of the quadrilateral KBPS, therefore it is also at right angles to all the straight lines which meet it and are in the plane of the quadrilateral. [:ref:`g.333`]
...
And the squares on AX, XB are equal to the square on AB, for the angle at X is right; [:ref:`g.60`] and the squares on AX, XK are equal to the square on AK. [id.]
...
And, if KD be joined, the rectangle DB, BZ is equal to the square on BK, and the rectangle DZ, ZB equal to the square on KZ; [:ref:`g.112`, :ref:`g.399`] therefore the square on KB is less than double of the square on KZ.
...
And the squares on BX, XA are equal to the square on BA, and the squares on KZ, ZA equal to the square on KA; [:ref:`g.60`] therefore the squares on BX, XA are equal to the squares on KZ, ZA, and of these the square on KZ is greater than the square on BX; therefore the remainder, the square on ZA, is less than the square on XA.
