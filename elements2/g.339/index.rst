...
:original_id: XI.9
:type: prop
:dependencies: g.334, g.336, g.338
...
Now, since EF is at right angles to each of the straight lines GH, GK, therefore EF is also at right angles to the plane through GH, GK. [:ref:`g.334`]

And EF is parallel to AB; therefore AB is also at right angles to the plane through HG, GK. [:ref:`g.338`]
...
But if two straight lines be at right angles to the same plane, the straight lines are parallel; [:ref:`g.336`] therefore AB is parallel to CD.