...
let it be divided into its straight lines at E; therefore AE, EB are straight lines incommensurable in square which make the sum of the squares on them medial, the rectangle contained by them medial, and furthermore the sum of the squares on AE, EB incommensurable with the rectangle AE, EB. [:ref:`g.387`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.428" [label="G.428", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.428/", target="_top"];
