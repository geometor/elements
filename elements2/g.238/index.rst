...
For, since A, B are prime to one another, and A by multiplying itself has made C, therefore C, B are prime to one another. [:ref:`g.236`]
...
Since then the two numbers A, C are prime to the two numbers B, E, both to each, therefore also the product of A, C is prime to the product of B, E. [:ref:`g.237`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.238" [label="G.238", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.238/", target="_top"];
