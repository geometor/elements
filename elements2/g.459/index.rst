...
:original_id: XIII.18
:type: prop
:dependencies: g.188, g.170, g.175, g.353, g.436, g.452, g.453, g.454, g.455, g.456, g.435, g.457, g.458, g.434, g.421
...
But, as BA is to AD, so is the square on BA to the square on AF, [:ref:`g.188`, :ref:`g.175`] for the triangle AFB is equiangular with the triangle AFD; therefore the square on BA is one and a half times the square on AF.

But the square on the diameter of the sphere is also one and a half times the square on the side of the pyramid. [:ref:`g.452`]
...
But, as AB is to BD, so is the square on AB to the square on BF; [:ref:`g.175`, :ref:`g.188`] therefore the square on AB is triple of the square on BF.

But the square on the diameter of the sphere is also triple of the square on the side of the cube. [:ref:`g.454`]
...
But the square on the diameter of the sphere is also double of the square on the side of the octahedron. [:ref:`g.453`]
...
But the square on the diameter of the sphere is also five times the square on the radius of the circle from which the icosahedron has been described. [:ref:`g.457`]

And AB is the diameter of the sphere; therefore KL is the radius of the circle from which the icosahedron has been described; therefore KL is a side of the hexagon in the said circle. [:ref:`g.434`]

And, since the diameter of the sphere is made up of the side of the hexagon and two of the sides of the decagon inscribed in the same circle, [:ref:`g.457`] and AB is the diameter of the sphere, while KL is a side of the hexagon, and AK is equal to LB, therefore each of the straight lines AK, LB is a side of the decagon inscribed in the circle from which the icosahedron has been described.

And, since LB belongs to a decagon, and ML to a hexagon, for ML is equal to KL, since it is also equal to HK, being the same distance from the centre, and each of the straight lines HK, KL is double of KC, therefore MB belongs to a pentagon. [:ref:`g.436`]

But the side of the pentagon is the side of the icosahedron; [:ref:`g.455`] therefore MB belongs to the icosahedron.

Now, since FB is a side of the cube, let it be cut in extreme and mean ratio at N, and let NB be the greater segment; therefore NB is a side of the dodecahedron. [:ref:`g.458`]
...
But the remaining two, I mean the side of the icosahedron and the side of the dodecahedron, are not in rational ratios either to one another or to the aforesaid sides; for they are irrational, the one being minor [:ref:`g.455`] and the other an apotome [:ref:`g.456`].

That the side MB of the icosahedron is greater than the side NB of the dodecahedron we can prove thus.

For, since the triangle FDB is equiangular with the triangle FAB, [:ref:`g.175`] proportionally, as DB is to BF, so is BF to BA. [:ref:`g.170`]

And, since the three straight lines are proportional, as the first is to the third, so is the square on the first to the square on the second; [:ref:`g.188`, :ref:`g.421`] therefore, as DB is to BA, so is the square on DB to the square on BF; therefore, inversely, as AB is to BD, so is the square on FB to the square on BD.
...
And, when AL is cut in extreme and mean ratio, KL is the greater segment, inasmuch as LK belongs to a hexagon, and KA to a decagon; [:ref:`g.435`] and, when FB is cut in extreme and mean ratio, NB is the greater segment; therefore KL is greater than NB.
