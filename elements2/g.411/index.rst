...
:original_id: X.59
:type: prop
:dependencies: g.66, g.70, g.167, g.343, g.347, g.357, g.387
...
Now, since EA is incommensurable in length with AB, therefore EA, AB are rational straight lines commensurable in square only; therefore AK, that is, the sum of the squares on MN, NO, is medial. [:ref:`g.357`]

Again, since ED is incommensurable in length with AB, therefore FE is also incommensurable with EK; [:ref:`g.347`] therefore FE, EK are rational straight lines commensurable in square only; therefore EL, that is, MR, that is, the rectangle MN, NO, is medial. [:ref:`g.357`]

And, since AE is incommensurable with EF, AK is also incommensurable with EL. [:ref:`g.167`, :ref:`g.343`]
...
Therefore MO is the side of the sum of two medial areas [:ref:`g.387`], and is the side
of AC. Q. E. D.
...
Since then a straight line has been cut into equal parts at D, and into unequal parts at C, therefore the rectangle AC, CB together with the square on CD is equal to the square on AD, [:ref:`g.66`] so that the rectangle AC, CB is less than double of the square on AD. 

But the squares on AC, CB are double of the squares on AD, DC; [:ref:`g.70`] therefore the squares on AC, CB are greater than twice the rectangle AC, CB. Q. E. D.]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.387" [label="G.387", URL="/elements2/g.387/", target="_top"];
     ...
     "G.411" [label="G.411", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.411/", target="_top"];
     ...
     "G.70" [label="G.70", URL="/elements2/g.70/", target="_top"];
