...
:original_id: XIII.10
:type: prop
:dependencies: g.36, g.45, g.11, g.12, g.63, g.107, g.185, g.205, g.170, g.434
...
And, since FA is equal to FB, and FH is perpendicular, therefore the angle AFK is also equal to the angle KFB. [:ref:`g.12`, :ref:`g.36`]

Hence the circumference AK is also equal to KB; [:ref:`g.107`] therefore the circumference AB is double of the circumference BK; therefore the straight line AK is a side of a decagon.
...
Therefore the whole circumference GB is also double of BM; hence the angle GFB is also double of the angle BFM. [:ref:`g.205`]
...
But the angle ABF is common to the two triangles ABF and BFN; therefore the remaining angle AFB is equal to the remaining angle BNF; [:ref:`g.45`] therefore the triangle ABF is equiangular with the triangle BFN.

Therefore, proportionally, as the straight line AB is to BF, so is FB to BN; [:ref:`g.170`] therefore the rectangle AB, BN is equal to the square on BF. [:ref:`g.185`]

Again, since AL is equal to LK, while LN is common and at right angles, therefore the base KN is equal to the base AN; [:ref:`g.11`] therefore the angle LKN is also equal to the angle LAN.
...
Therefore the remaining angle AKB is equal to the remaining angle KNA; [:ref:`g.45`] therefore the triangle KBA is equiangular with the triangle KNA.

Therefore, proportionally, as the straight line BA is to AK, so is KA to AN; [:ref:`g.170`] therefore the rectangle BA, AN is equal to the square on AK. [:ref:`g.185`]

But the rectangle AB, BN was also proved equal to the square on BF; therefore the rectangle AB, BN together with the rectangle BA, AN, that is, the square on BA [:ref:`g.63`], is equal to the square on BF together with the square on AK.

And BA is a side of the pentagon, BF of the hexagon [:ref:`g.434`], and AK of the decagon.
