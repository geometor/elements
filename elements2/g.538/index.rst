...
:original_id: XII.8
:type: prop
:dependencies: g.151, g.191, g.510, g.516, g.522, g.537
...
But the three parallelograms MB, BK, BN are equal and similar to their three opposites, and the three EQ, EO, ER are equal and similar to their three opposites. [:ref:`g.510`]
...
But similar parallelepipedal solids are in the triplicate ratio of their corresponding sides. [:ref:`g.522`]
...
But, as the solid BGML is to the solid EHQP, so is the pyramid ABCG to the pyramid DEFH, inasmuch as the pyramid is a sixth part of the solid, because the prism which is half of the parallelepipedal solid [:ref:`g.516`] is also triple of the pyramid. [:ref:`g.537`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.538" [label="G.538", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.538/", target="_top"];
