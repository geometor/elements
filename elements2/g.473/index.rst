...
For let BE be the annex to AB; therefore AE, EB are straight lines incommensurable in square which make the sum of the squares on AE, EB medial, but the rectangle contained by them rational. [:ref:`g.437`]
...
Therefore CD is a straight line which produces with a rational area a medial whole. [:ref:`g.437`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.473" [label="G.473", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.473/", target="_top"];
