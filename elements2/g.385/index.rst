...
:original_id: X.39
:type: prop
:dependencies: g.350, g.376, g.354, g.384
...
For let two straight lines AB, BC incommensurable in square, and fulfilling the given conditions [:ref:`g.376`
], be added together; I say that AC is irrational.

For, since the rectangle AB, BC is medial, twice the rectangle AB, BC is also medial. [:ref:`g.384`]

But the sum of the squares on AB, BC is rational; therefore twice the rectangle AB, BC is incommensurable with the sum of the squares on AB, BC, so that the squares on AB, BC together with twice the rectangle AB, BC that is, the square on AC, is also incommensurable with the sum of the squares on AB, BC; [:ref:`g.350`
] therefore the square on AC is irrational, so that AC is also irrational. [:ref:`g.354`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.385" [label="G.385", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.385/", target="_top"];
...
:ref:`g.392`, :ref:`g.408`, :ref:`g.419`, :ref:`g.426`, :ref:`g.429`
