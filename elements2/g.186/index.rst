...
:original_id: VI.18
:type: prop
:dependencies: g.33, g.45, g.170, g.174
...
Let ``DF`` be joined, and on the straight line ``AB``, and at the points ``A``, ``B`` on it, let the angle ``GAB`` be constructed equal to the angle at ``C``, and the angle ``ABG`` equal to the angle ``CDF``. [:ref:`g.33`]

Therefore the remaining angle ``CFD`` is equal to the angle ``AGB``; [:ref:`g.45`]
...
Again, on the straight line ``BG``, and at the points ``B``, ``G`` on it, let the angle ``BGH`` be constructed equal to the angle ``DFE``, and the angle ``GBH`` equal to the angle ``FDE``. [:ref:`g.33`]

Therefore the remaining angle at ``E`` is equal to the remaining angle at ``H``; [:ref:`g.45`]


.. container:: center

   therefore the triangle ``FDE`` is equiangular with the triangle ``GBH``; therefore, proportionally, as ``FD`` is to ``GB``, so is ``FE`` to ``GH``, and ``ED`` to ``HB``. [:ref:`g.170`]


But it was also proved that, as ``FD`` is to ``GB``, so is ``FC`` to ``GA``, and ``CD`` to ``AB``;
...
Therefore ``AH`` is equiangular with ``CE``; and they have the sides about their equal angles proportional;


.. container:: center

   therefore the rectilineal figure ``AH`` is similar to the rectilineal figure ``CE``. [:ref:`g.174`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.186" [label="G.186", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.186/", target="_top"];
...
:ref:`g.194`, :ref:`g.197`, :ref:`g.200`, :ref:`g.201`, :ref:`g.202`, :ref:`g.466`, :ref:`g.467`, :ref:`g.468`, :ref:`g.469`, :ref:`g.471`, :ref:`g.472`, :ref:`g.473`, :ref:`g.474`, :ref:`g.475`, :ref:`g.476`, :ref:`g.477`, :ref:`g.478`, :ref:`g.480`, :ref:`g.481`, :ref:`g.482`, :ref:`g.348`, :ref:`g.358`, :ref:`g.361`, :ref:`g.364`, :ref:`g.365`, :ref:`g.366`, :ref:`g.369`, :ref:`g.374`, :ref:`g.375`, :ref:`g.376`, :ref:`g.377`, :ref:`g.380`, :ref:`g.383`, :ref:`g.385`, :ref:`g.386`, :ref:`g.387`, :ref:`g.388`, :ref:`g.389`, :ref:`g.391`, :ref:`g.392`, :ref:`g.393`, :ref:`g.394`, :ref:`g.406`, :ref:`g.408`, :ref:`g.410`, :ref:`g.411`, :ref:`g.414`, :ref:`g.416`, :ref:`g.418`, :ref:`g.419`, :ref:`g.420`, :ref:`g.421`, :ref:`g.423`, :ref:`g.425`, :ref:`g.426`, :ref:`g.427`, :ref:`g.428`, :ref:`g.429`, :ref:`g.430`, :ref:`g.434`, :ref:`g.435`, :ref:`g.437`, :ref:`g.438`, :ref:`g.439`, :ref:`g.440`, :ref:`g.441`, :ref:`g.442`, :ref:`g.443`, :ref:`g.444`, :ref:`g.459`, :ref:`g.460`, :ref:`g.461`, :ref:`g.462`, :ref:`g.463`, :ref:`g.464`, :ref:`g.465`, :ref:`g.543`, :ref:`g.545`, :ref:`g.546`, :ref:`g.547`, :ref:`g.548`, :ref:`g.533`, :ref:`g.535`, :ref:`g.536`, :ref:`g.537`, :ref:`g.538`, :ref:`g.569`, :ref:`g.574`, :ref:`g.575`, :ref:`g.578`, :ref:`g.563`
