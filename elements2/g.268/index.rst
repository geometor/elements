...
:original_id: VIII.14
:type: prop
:dependencies: g.219, g.264, g.260
...
For let C by multiplying D make E; therefore A, E, B are continuously proportional in the ratio of C to D. [:ref:`g.264`]

And, since A, E, B are continuously proportional, and A measures B, therefore A also measures E. [:ref:`g.260`]

And, as A is to E, so is C to D; therefore also C measures D. [:ref:`g.219`]
...
And since, as C is to D, so is A to E, and C measures D, therefore A also measures E. [:ref:`g.219`]
