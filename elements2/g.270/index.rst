...
:original_id: VIII.15
:type: prop
:dependencies: g.219, g.260, g.269
...
Now it is manifest that E, F, G and A, H, K, B are continuously proportional in the ratio of C to D. [:ref:`g.269`]

And, since A, H, K, B are continuously proportional, and A measures B, therefore it also measures H. [:ref:`g.260`]

And, as A is to H, so is C to D; therefore C also measures D. [:ref:`g.219`]
...
And, since C measures D, and, as C is to D, so is A to H, therefore A also measures H, [:ref:`g.219`] so that A measures B also. Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.269" [label="G.269", style="rounded,filled", fillcolor=orange, URL="/elements2/g.269/", target="_top"];
     "G.260" [label="G.260", URL="/elements2/g.260/", target="_top"];
     "G.227" [label="G.227", URL="/elements2/g.227/", target="_top"];
     "G.224" [label="G.224", URL="/elements2/g.224/", target="_top"];
     "G.270" [label="G.270", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.270/", target="_top"];
     ...
     "G.259" [label="G.259", URL="/elements2/g.259/", target="_top"];
