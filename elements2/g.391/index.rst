...
:original_id: X.44
:type: prop
:dependencies: g.65, g.167, g.343, g.347, g.349, g.358, g.381, g.383, g.338, g.390
...
Let AB be a second bimedial straight line divided at C, so that AC, CB are medial straight lines commensurable in square only and containing a medial rectangle; [:ref:`g.383`
...
Now let a rational straight line EF be set out, let there be applied to EF the rectangular parallelogram EK equal to the square on AB, and let EG equal to the squares on AC, CB be subtracted; therefore the remainder HK is equal to twice the rectangle AC, CB. [:ref:`g.65`
]

Again, let there be subtracted EL, equal to the squares on AD, DB, which were proved less than the squares on AC, CB [:ref:`g.390`
...
And it is applied to the rational straight line EF; therefore EH is rational and incommensurable in length with EF. [:ref:`g.358`
]
...
But the squares on AC, CB are commensurable with the square on AC; for AC, CB are commensurable in square. [:ref:`g.349`
]

And twice the rectangle AC, CB is commensurable with the rectangle AC, CB. [:ref:`g.338`
]

Therefore the squares on AC, CB are also incommensurable with twice the rectangle AC, CB. [:ref:`g.347`
]

But EG is equal to the squares on AC, CB, and HK is equal to twice the rectangle AC, CB; therefore EG is incommensurable with HK, so that EH is also incommensurable in length with HN. [:ref:`g.167`
, :ref:`g.343`
]

And they are rational; therefore EH, HN are rational straight lines commensurable in square only.

But, if two rational straight lines commensurable in square only be added together, the whole is the irrational which is called binomial. [:ref:`g.381`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.391" [label="G.391", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.391/", target="_top"];
     ...
     "G.390" [label="G.390", style="rounded,filled", fillcolor=orange, URL="/elements2/g.390/", target="_top"];
     ...
     "G.383" [label="G.383", URL="/elements2/g.383/", target="_top"];
