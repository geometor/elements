...
For since, as A is to B, so is C to D, whatever part or parts A is of B, the same part or parts is C of D also. [:ref:`g.219`]

Therefore also the sum of A, C is the same part or the same parts of the sum of B, D that A is of B. [:ref:`g.216`]

Therefore, as A is to B, so are A, C to B, D. [:ref:`g.219`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.222" [label="G.222", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.222/", target="_top"];
     "G.222" -> "G.216";
     "G.222" -> "G.219";
   }
