...
:original_id: X.78
:type: prop
:dependencies: g.68, g.167, g.343, g.356, g.358, g.380, g.432
...
For from the straight line AB let there be subtracted the straight line BC incommensurable in square with AB and fulfilling the given conditions; [:ref:`g.380`]
...
Therefore the remainder FE is equal to the square on AC, [:ref:`g.68`] so that AC is the side
of FE.
...
And it is applied to the rational straight line DI, producing DF as breadth; therefore DF is also rational and incommensurable in length with DI. [:ref:`g.358`]
...
But, as DE is to DH, so also is DG to DF; [:ref:`g.167`] therefore DG is incommensurable with DF. [:ref:`g.343`]

And both are rational; therefore GD, DF are rational straight lines commensurable in square only.

Therefore FG is an apotome. [:ref:`g.432`]

And FH is rational; but the rectangle contained by a rational straight line and an apotome is irrational, [deduction from :ref:`g.356`] and its side
is irrational.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.438" [label="G.438", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.438/", target="_top"];
...
:ref:`g.468`, :ref:`g.474`, :ref:`g.477`, :ref:`g.444`, :ref:`g.462`
