...
:original_id: X.105
:type: prop
:dependencies: g.151, g.159, g.161, g.194, g.343, g.347, g.435, g.354, g.362
...
Let the same construction be made as before; then, since AE, EB are incommensurable in square, [:ref:`g.435`] therefore CF, FD are also incommensurable in square. [:ref:`g.347`]

Now since, as AE is to EB, so is CF to FD, [:ref:`g.151`, :ref:`g.159`] therefore also, as the square on AE is to the square on EB, so is the square on CF to the square on FD. [:ref:`g.194`]

Therefore, componendo, as the squares on AE, EB are to the square on EB, so are the squares on CF, FD to the square on FD. [:ref:`g.161`]

But the square on BE is commensurable with the square on DF; therefore the sum of the squares on AE, EB is also commensurable with the sum of the squares on CF, FD. [:ref:`g.159`, :ref:`g.343`]

But the sum of the squares on AE, EB is rational; [:ref:`g.435`] therefore the sum of the squares on CF, FD is also rational. [:ref:`g.354`]
...
But the rectangle AE, EB is medial; [:ref:`g.435`] therefore the rectangle CF, FD is also medial; [:ref:`g.362`] therefore CF, FD are straight lines incommensurable in square which make the sum of the squares on them rational, but the rectangle contained by them medial.

Therefore CD is minor. [:ref:`g.435`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.472" [label="G.472", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.472/", target="_top"];
