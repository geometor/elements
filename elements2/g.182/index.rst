...
:original_id: VI.14
:type: prop
:dependencies: g.23, g.150, g.144, g.148, g.167
...
.. container:: center
   ...
   therefore ``FB``, ``BG`` are also in a straight line. [:ref:`g.23`]
...
therefore, as ``AB`` is to ``FE``, so is ``BC`` to ``FE``. [:ref:`g.144`]

But, as ``AB`` is to ``FE``, so is ``DB`` to ``BE``, [:ref:`g.167`] and, as ``BC`` is to ``FE``, so is ``GB`` to ``BF``. [``id``.] therefore also, as ``DB`` is to ``BE``, so is ``GB`` to ``BF``. [:ref:`g.150`]
...
For since, as ``DB`` is to ``BE``, so is ``GB`` to ``BF``, while, as ``DB`` is to ``BE``, so is the parallelogram ``AB`` to the parallelogram ``FE``, [:ref:`g.167`] and, as ``GB`` is to ``BF``, so is the parallelogram ``BC`` to the parallelogram ``FE``, [:ref:`g.167`] therefore also, as ``AB`` is to ``FE``, so is ``BC`` to ``FE``; [:ref:`g.150`] therefore the parallelogram ``AB`` is equal to the parallelogram ``BC``. [:ref:`g.148`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.182" [label="G.182", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.182/", target="_top"];
...
:ref:`g.184`, :ref:`g.185`, :ref:`g.202`, :ref:`g.466`, :ref:`g.467`, :ref:`g.468`, :ref:`g.471`, :ref:`g.473`, :ref:`g.474`, :ref:`g.475`, :ref:`g.476`, :ref:`g.477`, :ref:`g.478`, :ref:`g.480`, :ref:`g.481`, :ref:`g.482`, :ref:`g.358`, :ref:`g.361`, :ref:`g.364`, :ref:`g.365`, :ref:`g.366`, :ref:`g.369`, :ref:`g.374`, :ref:`g.375`, :ref:`g.377`, :ref:`g.380`, :ref:`g.383`, :ref:`g.386`, :ref:`g.387`, :ref:`g.388`, :ref:`g.389`, :ref:`g.391`, :ref:`g.392`, :ref:`g.393`, :ref:`g.394`, :ref:`g.402`, :ref:`g.406`, :ref:`g.410`, :ref:`g.411`, :ref:`g.414`, :ref:`g.416`, :ref:`g.418`, :ref:`g.419`, :ref:`g.420`, :ref:`g.421`, :ref:`g.425`, :ref:`g.427`, :ref:`g.428`, :ref:`g.429`, :ref:`g.430`, :ref:`g.434`, :ref:`g.437`, :ref:`g.438`, :ref:`g.439`, :ref:`g.440`, :ref:`g.441`, :ref:`g.442`, :ref:`g.443`, :ref:`g.444`, :ref:`g.457`, :ref:`g.458`, :ref:`g.459`, :ref:`g.460`, :ref:`g.461`, :ref:`g.462`, :ref:`g.463`, :ref:`g.464`, :ref:`g.465`, :ref:`g.526`, :ref:`g.557`, :ref:`g.568`, :ref:`g.569`, :ref:`g.571`, :ref:`g.574`, :ref:`g.575`, :ref:`g.578`, :ref:`g.560`, :ref:`g.562`, :ref:`g.563`
