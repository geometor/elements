...
:original_id: X.103
:type: prop
:dependencies: g.151, g.159, g.179, g.343, g.346, g.347, g.348, g.432
...
For, since AB is an apotome, let BE be the annex to it; therefore AE, EB are rational straight lines commensurable in square only. [:ref:`g.432`]

Let it be contrived that the ratio of BE to DF is the same as the ratio of AB to CD; [:ref:`g.179`] therefore also, as one is to one, so are all to all; [:ref:`g.151`] therefore also, as the whole AE is to the whole CF, so is AB to CD.

But AB is commensurable in length with CD.

Therefore AE is also commensurable with CF, and BE with DF. [:ref:`g.343`]

And AE, EB are rational straight lines commensurable in square only; therefore CF, FD are also rational straight lines commensurable in square only. [:ref:`g.347`]

Now since, as AE is to CF, so is BE to DF, alternately therefore, as AE is to EB, so is CF to FD. [:ref:`g.159`]
...
If then the square on AE is greater than the square on EB by the square on a straight line commensurable with AE, the square on CF will also be greater than the square on FD by the square on a straight line commensurable with CF. [:ref:`g.348`]

And, if AE is commensurable in length with the rational straight line set out, CF is so also, [:ref:`g.346`] if BE, then DF also, [id.] and, if neither of the straight lines AE, EB, then neither of the straight lines CF, FD. [:ref:`g.347`]

But, if the square on AE is greater than the square on EB by the square on a straight line incommensurable with AE, the square on CF will also be greater than the square on FD by the square on a straight line incommensurable with CF. [:ref:`g.348`]

And, if AE is commensurable in length with the rational straight line set out, CF is so also, if BE, then DF also, [:ref:`g.346`] and, if neither of the straight lines AE, EB, then neither of the straight lines CF, FD. [:ref:`g.347`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.469" [label="G.469", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.469/", target="_top"];
