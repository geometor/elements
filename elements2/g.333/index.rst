...
Then, if the less be continually subtracted in turn from the greater, that which is left over will sometime measure the one before it, because AB, CD are not incommensurable; [cf. :ref:`g.332`] let AB, measuring ED, leave EC less than itself, let EC, measuring FB, leave AF less than itself, and let AF measure CE.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.333" [label="G.333", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.333/", target="_top"];
     "G.332" -> "G.331";
     "G.333" -> "G.332";
   }
