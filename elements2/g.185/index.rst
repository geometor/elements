...
But, if four straight lines be proportional, the rectangle contained by the extremes is equal to the rectangle contained by the means. [:ref:`g.184`]
...
But, if the rectangle contained by the extremes be equal to that contained by the means, the four straight lines are proportional. [:ref:`g.184`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.185" [label="G.185", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.185/", target="_top"];
