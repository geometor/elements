...
:original_id: X.114
:type: prop
:dependencies: g.162, g.167, g.343, g.480, g.346
...
For let an area, the rectangle AB, CD, be contained by the apotome AB and the binomial straight line CD, and let CE be the greater term of the latter; let the terms CE, ED of the binomial straight line be commensurable with the terms AF, FB of the apotome and in the same ratio; and let the side
...
Let its terms be KM, ML commensurable with the terms CE, ED of the binomial straight line and in the same ratio. [:ref:`g.480`]

But CE, ED are also commensurable with AF, FB and in the same ratio; therefore, as AF is to FB, so is KM to ML.

Therefore, alternately, as AF is to KM, so is BF to LM; therefore also the remainder AB is to the remainder KL as AF is to KM. [:ref:`g.162`]

But AF is commensurable with KM; [:ref:`g.346`] therefore AB is also commensurable with KL. [:ref:`g.343`]

And, as AB is to KL, so is the rectangle CD, AB to the rectangle CD, KL; [:ref:`g.167`] therefore the rectangle CD, AB is also commensurable with the rectangle CD, KL. [:ref:`g.343`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.480" [label="G.480", URL="/elements2/g.480/", target="_top"];
     ...
     "G.482" [label="G.482", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.482/", target="_top"];
