...
:original_id: VIII.24
:type: prop
:dependencies: g.274, g.278, g.261
...
Therefore one mean proportional number falls between C, D. [:ref:`g.274`]

And, as C is to D, so is A to B; therefore one mean proportional number falls between A, B also. [:ref:`g.261`]

And A is square; therefore B is also square. [:ref:`g.278`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.280" [label="G.280", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.280/", target="_top"];
