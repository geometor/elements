...
:original_id: X.31
:type: prop
:dependencies: g.343, g.348, g.357, g.361, g.371, g.373
...
Let there be set out two rational straight lines A, B commensurable in square only and such that the square on A, being the greater, is greater than the square on B the less by the square on a straight line commensurable in length with A. [:ref:`g.371`]

And let the square on C be equal to the rectangle A, B.

Now the rectangle A, B is medial; [:ref:`g.357`] therefore the square on C is also medial; therefore C is also medial. [:ref:`g.357`]
...
But A is commensurable with B in square only; therefore C is also commensurable with D in square only. [:ref:`g.343`]

And C is medial; therefore D is also medial. [:ref:`g.361`, addition]

And since, as A is to B, so is C to D, and the square on A is greater than the square on B by the square on a straight line commensurable with A, therefore also the square on C is greater than the square on D by the square on a straight line commensurable with C. [:ref:`g.348`]
...
Similarly also it can be proved that the square on C exceeds the square on D by the square on a straight line incommensurable with C, when the square on A is greater than the square on B by the square on a straight line incommensurable with A. [:ref:`g.373`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.374" [label="G.374", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.374/", target="_top"];
...
:ref:`g.467`, :ref:`g.473`, :ref:`g.476`, :ref:`g.377`, :ref:`g.386`, :ref:`g.393`, :ref:`g.410`, :ref:`g.420`, :ref:`g.427`, :ref:`g.429`, :ref:`g.437`, :ref:`g.443`, :ref:`g.461`
