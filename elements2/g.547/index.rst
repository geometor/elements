...
:original_id: XII.14
:type: prop
:dependencies: g.542, g.543, g.546
...
Since then the cylinders EB, CM are of the same height, they are to one another as their bases. [:ref:`g.543`]

But the bases are equal to one another; therefore the cylinders EB, CM are also equal.

And, since the cylinder FM has been cut by the plane CD which is parallel to its opposite planes, therefore, as the cylinder CM is to the cylinder FD, so is the axis LN to the axis KL. [:ref:`g.546`]
...
But, as the cylinder EB is to the cylinder FD, so is the cone ABG to the cone CDK. [:ref:`g.542`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.547" [label="G.547", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.547/", target="_top"];
