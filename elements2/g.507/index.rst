...
Now, since the solid angle at B is contained by the three plane angles CBA, ABD, CBD, any two are greater than the remaining one; [:ref:`g.506`] therefore the angles CBA, ABD are greater than the angle CBD.
...
But the three angles CBD, BDC, BCD are equal to two right angles; [:ref:`g.45`] therefore the six angles CBA, ABD, BCA, ACD, CDA, ADB are greater than two right angles.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.506" [label="G.506", URL="/elements2/g.506/", target="_top"];
     ...
     "G.507" [label="G.507", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.507/", target="_top"];
     "G.507" -> "G.506";
     "G.506" -> "G.35";
     "G.17" -> "G.16";
     "G.42" -> "G.41";
