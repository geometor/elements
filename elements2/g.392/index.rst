...
:original_id: XII.12
:type: prop
:dependencies: g.127, g.151, g.159, g.163, g.171, g.172, g.174, g.386, g.391, g.359, g.389, g.384
...
Now, since the cone ABCDL is similar to the cone EFGHN, therefore, as BD is to FH, so is the axis KL to the axis MN. [:ref:`g.391`]
...
Therefore the pyramid of which the triangle BKT is the base and the point L the vertex is also similar to the pyramid of which the triangle FMP is the base and the point N the vertex, for they are contained by similar planes equal in multitude. [:ref:`g.359`]

But similar pyramids which have triangular bases are to one another in the triplicate ratio of their corresponding sides. [:ref:`g.384`]
...
But, as the cone is to the cone, so is the cylinder to the cylinder, for the cylinder which is on the same base as the cone and of equal height with it is triple of the cone; [:ref:`g.389`] therefore the cylinder also has to the cylinder the ratio triplicate of that which BD has to FH.
