...
Let AB be a major straight line divided at C, so that AC, CB are incommensurable in square and make the sum of the squares on AC, CB rational, but the rectangle AC, CB medial; [:ref:`g.385`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.392" [label="G.392", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.392/", target="_top"];
