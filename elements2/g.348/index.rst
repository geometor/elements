...
:original_id: XI.17
:type: prop
:dependencies: g.150, g.168, g.347
...
Now, since the two parallel planes KL, MN are cut by the plane EBDO, their common sections EO, BD are parallel. [:ref:`g.347`]
...
And, since the straight line EO has been drawn parallel to BD, one of the sides of the triangle ABD, therefore, proportionally, as AE is to EB, so is AO to OD. [:ref:`g.168`]
...
But it was also proved that, as AO is to OD, so is AE to EB; therefore also, as AE is to EB, so is CF to FD. [:ref:`g.150`]
