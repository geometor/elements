...
Therefore no number will measure the numbers AB, CD; therefore AB, CD are prime to one another. [:ref:`g.206`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.207" [label="G.207", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.207/", target="_top"];
     "G.207" -> "G.206";
   }
