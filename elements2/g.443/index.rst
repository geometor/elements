...
Let AB be the straight line which produces with a rational area a medial whole, and let BC be an annex to AB; therefore AC, CB are straight lines incommensurable in square which fulfil the given conditions. [:ref:`g.437`]

I say that no other straight line can be annexed to AB which fulfils the same conditions.

For, if possible, let BD be so annexed; therefore AD, DB are also straight lines incommensurable in square which fulfil the given conditions. [:ref:`g.437`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.443" [label="G.443", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.443/", target="_top"];
