...
:original_id: X.109
:type: prop
:dependencies: g.347, g.432, g.458, g.461, g.447, g.453
...
It follows then that FH is rational and incommensurable in length with FG, while KF is rational and commensurable in length with FG; therefore FH, FK are rational straight lines commensurable in square only; [:ref:`g.347`] therefore KH is an apotome, and FK the annex to it. [:ref:`g.432`]
...
If then the square on HF is greater than the square on FK by the square on a straight line commensurable with HF, while the annex FK is commensurable in length with the rational straight line FG set out, KH is a second apotome. [:ref:`g.447`]

But FG is rational; so that the side
of LH, that is, of EC, is a first apotome of a medial straight line. [:ref:`g.458`]

But, if the square on HF is greater than the square on FK by the square on a straight line incommensurable with HF, while the annex FK is commensurable in length with the rational straight line FG set out, KH is a fifth apotome; [:ref:`g.453`] so that the side
of EC is a straight line which produces with a rational area a medial whole. [:ref:`g.461`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.476" [label="G.476", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.476/", target="_top"];
     ...
     "G.461" [label="G.461", URL="/elements2/g.461/", target="_top"];
     ...
     "G.436" [label="G.436", style="rounded,filled", fillcolor=orange, URL="/elements2/g.436/", target="_top"];
     ...
     "G.458" [label="G.458", URL="/elements2/g.458/", target="_top"];
     ...
     "G.437" [label="G.437", URL="/elements2/g.437/", target="_top"];
