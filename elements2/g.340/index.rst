...
For, if they are commensurable, A will have to B the ratio which a number has to a number. [:ref:`g.337`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.340" [label="G.340", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.340/", target="_top"];
