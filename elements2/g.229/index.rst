...
:original_id: VII.19
:type: prop
:dependencies: g.144, g.148, g.227, g.228
...
Therefore, as C is to D, so is G to E. [:ref:`g.227`]
...
Therefore, as A is to B, so is G to F. [:ref:`g.228`]
...
.. container:: center
   ...
   therefore E is equal to F. [cf. :ref:`g.148`]


Again, let E be equal to F; I say that, as A is to B, so is C to D.

For, with the same construction, since E is equal to F, therefore, as G is to E, so is G to F. [cf. :ref:`g.144`]

But, as G is to E, so is C to D, [:ref:`g.227`]


.. container:: center

   and, as G is to F, so is A to B. [:ref:`g.228`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.229" [label="G.229", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.229/", target="_top"];
