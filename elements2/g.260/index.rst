...
For, if A does not measure B, neither will any other of the numbers measure any other. [:ref:`g.259`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.260" [label="G.260", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.260/", target="_top"];
...
:ref:`g.268`, :ref:`g.270`, :ref:`g.271`, :ref:`g.272`
