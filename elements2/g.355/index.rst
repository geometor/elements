...
And, as BD is to BC, so is DA to AC. [:ref:`g.167`]

Therefore DA is commensurable with AC. [:ref:`g.343`]

But DA is rational; therefore AC is also rational. [:ref:`g.354`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.355" [label="G.355", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.355/", target="_top"];
...
:ref:`g.475`, :ref:`g.476`, :ref:`g.364`, :ref:`g.402`, :ref:`g.404`, :ref:`g.408`, :ref:`g.410`, :ref:`g.429`, :ref:`g.457`, :ref:`g.458`, :ref:`g.460`, :ref:`g.461`, :ref:`g.569`, :ref:`g.574`, :ref:`g.578`
