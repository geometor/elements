...
:original_id: XIII.9
:type: prop
:dependencies: g.45, g.12, g.205, g.170, g.434
...
And, since the straight line EC is equal to CD, for each of them is equal to the side of the hexagon inscribed in the circle ABC, [:ref:`g.434`] the angle CED is also equal to the angle CDE; [:ref:`g.12`] therefore the angle ECB is double of the angle EDC. [:ref:`g.45`]
