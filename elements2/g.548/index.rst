...
:original_id: XII.15
:type: prop
:dependencies: g.150, g.144, g.148, g.543, g.546
...
But cones and cylinders which are of the same height are to one another as their bases; [:ref:`g.543`] therefore the base ABCD is also equal to the base EFGH.
...
Now, since the cylinder AO is equal to the cylinder EP, therefore, as the cylinder AO is to the cylinder ES, so is the cylinder EP to the cylinder ES. [:ref:`g.144`]

But, as the cylinder AO is to the cylinder ES, so is the base ABCD to the base EFGH, for the cylinders AO, ES are of the same height; [:ref:`g.543`] and, as the cylinder EP is to the cylinder ES, so is the height MN to the height QN, for the cylinder EP has been cut by a plane which is parallel to its opposite planes. [:ref:`g.546`]

Therefore also, as the base ABCD is to the base EFGH, so is the height MN to the height QN. [:ref:`g.150`]
...
But, as the base ABCD is to the base EFGH, so is the cylinder AO to the cylinder ES, for they are of the same height; [:ref:`g.543`] and, as the height MN is to QN, so is the cylinder EP to the cylinder ES; [:ref:`g.546`] therefore, as the cylinder AO is to the cylinder ES, so is the cylinder EP to the cylinder ES. [:ref:`g.150`]

Therefore the cylinder AO is equal to the cylinder EP. [:ref:`g.148`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.548" [label="G.548", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.548/", target="_top"];
     "G.546" [label="G.546", URL="/elements2/g.546/", target="_top"];
