...
:original_id: X.30
:type: prop
:dependencies: g.60, g.112, g.342, g.372, g.344, g.370
...
Let there be set out a rational straight line AB, and two square numbers CE, ED such that their sum CD is not square; [:ref:`g.372`]

let there be described on AB the semicircle AFB, let it be contrived that, as DC is to CE, so is the square on BA to the square on AF, [:ref:`g.344`] and let FB be joined.
...
And since, as DC is to CE, so is the square on BA to the square on AF, therefore, convertendo, as CD is to DE, so is the square on AB to the square on BF. [:ref:`g.370`, :ref:`g.112`, :ref:`g.60`]

But CD has not to DE the ratio which a square number has to a square number; therefore neither has the square on AB to the square on BF the ratio which a square number has to a square number; therefore AB is incommensurable in length with BF. [:ref:`g.342`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.373" [label="G.373", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.373/", target="_top"];
...
:ref:`g.466`, :ref:`g.467`, :ref:`g.468`, :ref:`g.472`, :ref:`g.473`, :ref:`g.474`, :ref:`g.475`, :ref:`g.476`, :ref:`g.477`, :ref:`g.374`, :ref:`g.375`, :ref:`g.376`, :ref:`g.377`, :ref:`g.380`, :ref:`g.385`, :ref:`g.386`, :ref:`g.387`, :ref:`g.392`, :ref:`g.393`, :ref:`g.408`, :ref:`g.410`, :ref:`g.411`, :ref:`g.419`, :ref:`g.420`, :ref:`g.421`, :ref:`g.426`, :ref:`g.427`, :ref:`g.428`, :ref:`g.429`, :ref:`g.430`, :ref:`g.435`, :ref:`g.437`, :ref:`g.438`, :ref:`g.442`, :ref:`g.443`, :ref:`g.444`, :ref:`g.460`, :ref:`g.461`, :ref:`g.462`, :ref:`g.569`, :ref:`g.574`, :ref:`g.578`
