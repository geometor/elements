...
:original_id: IX.8
:type: prop
:dependencies: g.219, g.278, g.279
...
For since, as the unit is to A, so is A to B, therefore the unit measures the number A the same number of times that A measures B. [:ref:`g.219`]
...
And, since B, C, D are in continued proportion, and B is square, therefore D is also square. [:ref:`g.278`]
...
And, since C, D, E, F are in continued proportion, and C is cube, therefore F is also cube. [:ref:`g.279`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.292" [label="G.292", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.292/", target="_top"];
...
:ref:`g.294`, :ref:`g.298`, :ref:`g.299`, :ref:`g.322`, :ref:`g.329`, :ref:`g.293`
