...
:original_id: X.23
:type: prop
:dependencies: g.167, g.343, g.347, g.357, g.358, g.359, g.360
...
and to CD let the rectangular area CE equal to the square on A be applied, producing ED as breadth; therefore ED is rational and incommensurable in length with CD. [:ref:`g.358`]
...
And, as EC is to CF, so is ED to DF; [:ref:`g.167`] therefore ED is commensurable in length with DF. [:ref:`g.343`]

But ED is rational and incommensurable in length with DC; therefore DF is also rational [:ref:`g.359`] and incommensurable in length with DC. [:ref:`g.347`]

Therefore CD, DF are rational and commensurable in square only.

But the straight line the square on which is equal to the rectangle contained by rational straight lines commensurable in square only is medial; [:ref:`g.357`] therefore the side of the square equal to the rectangle CD, DF is medial.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.361" [label="G.361", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.361/", target="_top"];
