...
:original_id: X.68
:type: prop
:dependencies: g.150, g.159, g.161, g.191, g.343, g.385, g.362
...
Let AB be divided at E; therefore AE, EB are straight lines incommensurable in square which make the sum of the squares on them rational, but the rectangle contained by them medial. [:ref:`g.385`]

Let the same construction be made as before.

Then since, as AB is to CD, so is AE to CF, and EB to FD, therefore also, as AE is to CF, so is EB to FD. [:ref:`g.150`]

But AB is commensurable with CD; therefore AE, EB are also commensurable with CF, FD respectively. [:ref:`g.343`]

And since, as AE is to CF, so is EB to FD, alternately also, as AE is to EB, so is CF to FD; [:ref:`g.159`] therefore also, componendo, as AB is to BE, so is CD to DF; [:ref:`g.161`] therefore also, as the square on AB is to the square on BE, so is the square on CD to the square on DF. [:ref:`g.191`]

Similarly we can prove that, as the square on AB is to the square on AE, so also is the square on CD to the square on CF.

Therefore also, as the square on AB is to the squares on AE, EB, so is the square on CD to the squares on CF, FD; therefore also, alternately, as the square on AB is to the square on CD, so are the squares on AE, EB to the squares on CF, FD. [:ref:`g.159`]
...
And twice the rectangle AE, EB is medial; therefore twice the rectangle CF, FD is also medial. [:ref:`g.362`]

Therefore CF, FD are straight lines incommensurable in square which make, at the same time, the sum of the squares on them rational, but the rectangle contained by them medial; therefore the whole CD is the irrational straight line called major. [:ref:`g.385`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.426" [label="G.426", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.426/", target="_top"];
