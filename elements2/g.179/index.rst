...
Let two straight lines ``DE``, ``DF`` be set out containing any angle ``EDF``; let ``DG`` be made equal to ``A``, ``GE`` equal to ``B``, and further ``DH`` equal to ``C``; let ``GH`` be joined, and let ``EF`` be drawn through ``E`` parallel to it. [:ref:`g.44`]

Since, then, ``GH`` has been drawn parallel to ``EF``, one of the sides of the triangle ``DEF``, therefore, as ``DG`` is to ``GE``, so is ``DH`` to ``HF``. [:ref:`g.168`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.179" [label="G.179", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.179/", target="_top"];
...
:ref:`g.194`, :ref:`g.195`, :ref:`g.258`, :ref:`g.466`, :ref:`g.467`, :ref:`g.468`, :ref:`g.469`, :ref:`g.471`, :ref:`g.472`, :ref:`g.473`, :ref:`g.474`, :ref:`g.475`, :ref:`g.476`, :ref:`g.477`, :ref:`g.478`, :ref:`g.480`, :ref:`g.481`, :ref:`g.482`, :ref:`g.348`, :ref:`g.358`, :ref:`g.361`, :ref:`g.364`, :ref:`g.365`, :ref:`g.366`, :ref:`g.369`, :ref:`g.374`, :ref:`g.375`, :ref:`g.377`, :ref:`g.380`, :ref:`g.383`, :ref:`g.386`, :ref:`g.387`, :ref:`g.388`, :ref:`g.389`, :ref:`g.391`, :ref:`g.392`, :ref:`g.393`, :ref:`g.394`, :ref:`g.406`, :ref:`g.410`, :ref:`g.411`, :ref:`g.414`, :ref:`g.416`, :ref:`g.418`, :ref:`g.419`, :ref:`g.420`, :ref:`g.421`, :ref:`g.423`, :ref:`g.425`, :ref:`g.427`, :ref:`g.428`, :ref:`g.429`, :ref:`g.430`, :ref:`g.434`, :ref:`g.437`, :ref:`g.438`, :ref:`g.439`, :ref:`g.440`, :ref:`g.441`, :ref:`g.442`, :ref:`g.443`, :ref:`g.444`, :ref:`g.459`, :ref:`g.461`, :ref:`g.462`, :ref:`g.463`, :ref:`g.464`, :ref:`g.465`, :ref:`g.514`, :ref:`g.543`, :ref:`g.545`, :ref:`g.546`, :ref:`g.547`, :ref:`g.548`, :ref:`g.533`, :ref:`g.535`, :ref:`g.536`, :ref:`g.537`, :ref:`g.538`, :ref:`g.575`, :ref:`g.578`, :ref:`g.563`
