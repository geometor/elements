...
and let the square on C be equal to the rectangle B, A; therefore C is irrational; [:ref:`g.354`] for that which is contained by an irrational and a rational straight line is irrational. [deduction from :ref:`g.356`]
...
Again, let the square on D be equal to the rectangle B, C; therefore the square on D is irrational. [deduction from :ref:`g.356`]

Therefore D is irrational; [:ref:`g.354`] and it is not the same with any of the preceding, for the square on none of the preceding, if applied to a rational straight line, produces C as breadth.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.483" [label="G.483", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.483/", target="_top"];
