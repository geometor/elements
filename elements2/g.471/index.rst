...
:original_id: X.104
:type: prop
:dependencies: g.151, g.159, g.179, g.343, g.347, g.361, g.354, g.362, g.470
...
Therefore AE, EB are medial straight lines commensurable in square only. [:ref:`g.470`]

Let it be contrived that, as AB is to CD, so is BE to DF; [:ref:`g.179`] therefore AE is also commensurable with CF, and BE with DF. [:ref:`g.151`, :ref:`g.343`]

But AE, EB are medial straight lines commensurable in square only; therefore CF, FD are also medial straight lines [:ref:`g.361`] commensurable in square only; [:ref:`g.347`] therefore CD is an apotome of a medial straight line. [:ref:`g.470`]
...
But the square on AE is commensurable with the square on CF; therefore the rectangle AE, EB is also commensurable with the rectangle CF, FD. [:ref:`g.159`, :ref:`g.343`]

Therefore, if the rectangle AE, EB is rational, the rectangle CF, FD will also be rational, [:ref:`g.354`] and if the rectangle AE, EB is medial, the rectangle CF, FD is also medial. [:ref:`g.362`]

Therefore CD is an apotome of a medial straight line and the same in order with AB. [:ref:`g.470`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.471" [label="G.471", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.471/", target="_top"];
     ...
     "G.470" [label="G.470", style="rounded,filled", fillcolor=orange, URL="/elements2/g.470/", target="_top"];
