...
:original_id: X.89
:type: prop
:dependencies: g.338, g.432, g.342, g.453, g.370
...
Since then, as the square on BG is to the square on GC, so is DE to EF, therefore, convertendo, as ED is to DF, so is the square on BG to the square on H. [:ref:`g.370`]

But ED has not to DF the ratio which a square number has to a square number; therefore neither has the square on BG to the square on H the ratio which a square number has to a square number; therefore BG is incommensurable in length with H. [:ref:`g.342`]
...
And the annex CG is commensurable in length with the rational straight line A set out; therefore BC is a fifth apotome. [:ref:`g.453`]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.453" [label="G.453", style="rounded,filled", fillcolor=orange, URL="/elements2/g.453/", target="_top"];
     ...
     "G.454" [label="G.454", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.454/", target="_top"];
