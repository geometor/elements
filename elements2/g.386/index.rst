...
:original_id: X.40
:type: prop
:dependencies: g.350, g.377, g.354
...
For let two straight lines AB, BC incommensurable in square, and fulfilling the given conditions [:ref:`g.377`
], be added together; I say that AC is irrational.

For, since the sum of the squares on AB, BC is medial, while twice the rectangle AB, BC is rational, therefore the sum of the squares on AB, BC is incommensurable with twice the rectangle AB, BC; so that the square on AC is also incommensurable with twice the rectangle AB, BC. [:ref:`g.350`
]

But twice the rectangle AB, BC is rational; therefore the square on AC is irrational.

Therefore AC is irrational. [:ref:`g.354`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "G.386" [label="G.386", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.386/", target="_top"];
...
:ref:`g.393`, :ref:`g.410`, :ref:`g.420`, :ref:`g.427`, :ref:`g.429`
