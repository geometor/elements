...
But, if two numbers by multiplying one another make some number, and any prime number measure the product, it will also measure one of the original numbers; [:ref:`g.241`] therefore B, C, D will measure one of the numbers E, F.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.241" [label="G.241", URL="/elements2/g.241/", target="_top"];
     "G.240" [label="G.240", style="rounded,filled", fillcolor=orange, URL="/elements2/g.240/", target="_top"];
     ...
     "G.300" [label="G.300", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.300/", target="_top"];
