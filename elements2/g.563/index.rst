...
:original_id: XIII.6
:type: prop
:dependencies: g.185, g.556, g.338, g.432, g.342, g.463, g.354, g.557
...
Since then the straight line AB has been cut in extreme and mean ratio, and to the greater segment AC is added AD which is half of AB, therefore the square on CD is five times the square on DA. [:ref:`g.557`]

Therefore the square on CD has to the square on DA the ratio which a number has to a number; therefore the square on CD is commensurable with the square on DA. [:ref:`g.338`]

But the square on DA is rational, for DA is rational, being half of AB which is rational; therefore the square on CD is also rational; [:ref:`g.354`] therefore CD is also rational.

And, since the square on CD has not to the square on DA the ratio which a square number has to a square number, therefore CD is incommensurable in length with DA; [:ref:`g.342`] therefore CD, DA are rational straight lines commensurable in square only; therefore AC is an apotome. [:ref:`g.432`]

Again, since AB has been cut in extreme and mean ratio, and AC is the greater segment, therefore the rectangle AB, BC is equal to the square on AC. [:ref:`g.556`, :ref:`g.185`]

Therefore the square on the apotome AC, if applied to the rational straight line AB, produces BC as breadth.

But the square on an apotome, if applied to a rational straight line, produces as breadth a first apotome; [:ref:`g.463`] therefore CB is a first apotome.
...
.. graphviz::
   ...
   digraph {
     ...
     "G.563" [label="G.563", style="rounded,filled", fillcolor=lightblue, URL="/elements2/g.563/", target="_top"];
     ...
     "G.557" [label="G.557", URL="/elements2/g.557/", target="_top"];
