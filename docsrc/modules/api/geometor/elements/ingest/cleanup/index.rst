geometor.elements.ingest.cleanup
================================

.. py:module:: geometor.elements.ingest.cleanup
...
.. autoapisummary::
   ...
   geometor.elements.ingest.cleanup.clean_image
...
.. py:function:: clean_image(pil_image, white_point=226)
   ...
   :param white_point: The pixel value (0-255) to map to pure white (255).
   :type white_point: int
