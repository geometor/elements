...
I say that *BD*, *DC* are less than the remaining two sides *BA*, *AC*, but contain an angle *BDC* greater than the angle *BAC*.

For let *BD* be drawn through to *E*.

Then, since in any triangle two sides are greater than the remaining :ref:`I. 20 <elem.1.20>`] therefore, in the triangle ABE, the two sides AB, AE are greater than BE.
...
Again, since in any triangle the exterior angle is greater than the interior and opposite angle, [:ref:`I. 16 <elem.1.16>`] therefore, in the triangle *CDE*, the exterior angle BDC is greater than the angle CED.
