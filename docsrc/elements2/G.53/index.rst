...
:excerpt: Equal triangles which are on equal bases and on the same side are also in the same parallels.

**Heath ID:** `I.40 <https://geometor.github.io/euclid/I/40/>`_
