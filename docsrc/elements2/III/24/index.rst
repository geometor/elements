...
,
CFD
be similar segments of circles on equal straight lines
AB
,
CD
;
...
CFD
, it will either fall with it, or outside it;
or it will fall awry, as
CGD
, and a circle cuts a circle at more points than two : which is impossible. [
III. 10
]
...
, the segment
AEB
will not fail to coincide with
CFD
also;
...
fall awry, παραλλάξει, the same word as used in the like case in I. 8. The word implies that the applied figure will partly fall short of, and partly overlap, the figure to which it is applied.