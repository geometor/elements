...
.. graphviz::
   ...
   digraph {
     ...
     "III.14" [style="rounded,filled", fillcolor=lightblue, URL="/elements2/III/14/", target="_top"];
     ...
     "III.def.4" [style="rounded,filled", fillcolor=orange, URL="/elements2/III/def.4/", target="_top"];
