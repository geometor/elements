...
.. graphviz::
   ...
   digraph {
     ...
     "III.15" [style="rounded,filled", fillcolor=lightblue, URL="/elements2/III/15/", target="_top"];
     ...
     "III.14" [URL="/elements2/III/14/", target="_top"];
     ...
     "III.def.5" [style="rounded,filled", fillcolor=orange, URL="/elements2/III/def.5/", target="_top"];
