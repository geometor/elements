...
Since then the cylinders EB, CM are of the same height, they are to one another as their bases. [:ref:`XII.11`]

But the bases are equal to one another; therefore the cylinders EB, CM are also equal.

And, since the cylinder FM has been cut by the plane CD which is parallel to its opposite planes, therefore, as the cylinder CM is to the cylinder FD, so is the axis LN to the axis KL. [:ref:`XII.13`]
...
But, as the cylinder EB is to the cylinder FD, so is the cone ABG to the cone CDK. [:ref:`XII.10`]
