...
:excerpt: On a given finite straight line to construct an equilateral triangle.

**Heath ID:** `I.1 <https://geometor.github.io/euclid/I/1/>`_
...
.. graphviz::
   ...
   digraph {
     ...
     "G.5" [label="G.5", penwidth=3, color="white", fillcolor="#555555", URL="/elements2/G.5/", target="_top"];
