...
.. graphviz::
   ...
   digraph {
     ...
     "IV.4" [style="rounded,filled", fillcolor=lightblue, URL="/elements2/IV/4/", target="_top"];
     "I.1" [URL="/elements2/I/1/", target="_top"];
     "IV.13" [URL="/elements2/IV/13/", target="_top"];
     ...
     "IV.def.5" [style="rounded,filled", fillcolor=orange, URL="/elements2/IV/def.5/", target="_top"];
