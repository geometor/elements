...
Let it be contrived that, as CA is to AB, so is the square on EF to the square on FG. [:ref:`X.6.p.1`]
...
Let then the squares on EF, H be equal to the square on GF; therefore, convertendo, as the number AB is to BC, so is the square on GF to the square on H. [:ref:`V.19.p.1`]
