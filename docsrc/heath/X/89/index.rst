...
Since then, as the square on BG is to the square on GC, so is DE to EF, therefore, convertendo, as ED is to DF, so is the square on BG to the square on H. [:ref:`V.19.p.1`]
...
And the annex CG is commensurable in length with the rational straight line A set out; therefore BC is a fifth apotome. [:ref:`X.def.3.5`]
