...
:type: None
:tags: line
:dependencies: X.12, X.13, X.15, X.60, X.73, X.97, elem.10.def.2.1, elem.10.def.3.1




.. figure:: X.111.graphic.inverted.png
...
Then, since AB is an apotome, DE is a first apotome. [:ref:`X.97`]

Let EF be the annex to it; therefore DF, FE are rational straight lines commensurable in square only, the square on DF is greater than the square on FE by the square on a straight line commensurable with DF, and DF is commensurable in length with the rational straight line DC set out. [:ref:`elem.10.def.3.1`]

Again, since AB is binomial, therefore DE is a first binomial straight line. [:ref:`X.60`]

Let it be divided into its terms at G, and let DG be the greater term; therefore DG, GE are rational straight lines commensurable in square only, the square on DG is greater than the square on GE by the square on a straight line commensurable with DG, and the greater term DG is commensurable in length with the rational straight line DC set out. [:ref:`elem.10.def.2.1`]

Therefore DF is also commensurable in length with DG; [:ref:`X.12`] therefore the remainder GF is also commensurable in length with DF. [:ref:`X.15`]

But DF is incommensurable in length with EF; therefore FG is also incommensurable in length with EF. [:ref:`X.13`]

Therefore GF, FE are rational straight lines commensurable in square only; therefore EG is an apotome. [:ref:`X.73`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.111" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/111/", target="_top"];
     ...
     "X.60" [URL="/heath/X/60/", target="_top"];
