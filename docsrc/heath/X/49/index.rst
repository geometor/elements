...
Let it be contrived then that, as the number CA is to AB, so also is the square on EF to the square on FG; [:ref:`X.6.p.1`] therefore the square on EF is commensurable with the square on FG. [:ref:`X.6`]
...
Let the squares on EF, H be equal to the square on GF; therefore, convertendo, as AB is to BC, so is the square on FG to the square on H. [:ref:`V.19.p.1`]
