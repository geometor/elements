...
the annex GD is commensurable in length with the rational straight line AC set out, and the square on the whole AG is greater than the square on the annex DG by the square on a straight line incommensurable with AG. [:ref:`X.def.3.5`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.def.3.5" [style="rounded,filled", fillcolor=orange, URL="/heath/X/def.3.5/", target="_top"];
