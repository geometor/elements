...
.. figure:: X.83.graphic.inverted.png
...
Let AB be the straight line which produces with a rational area a medial whole, and let BC be an annex to AB; therefore AC, CB are straight lines incommensurable in square which fulfil the given conditions. [:ref:`X.77`]

I say that no other straight line can be annexed to AB which fulfils the same conditions.

For, if possible, let BD be so annexed; therefore AD, DB are also straight lines incommensurable in square which fulfil the given conditions. [:ref:`X.77`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.83" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/83/", target="_top"];
