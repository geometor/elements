...
:type: prop
:tags: line
:dependencies: II.7, V.11, VI.1, X.11, X.13, X.17, X.22, X.73, X.75, X.def.3.3, elem.10.15 elem.10.23.p.1
...
And neither of the straight lines CM, MF is commensurable in length with the rational straight line CD set out; therefore CF is a third apotome. [:ref:`X.def.3.3`]
