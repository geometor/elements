...
.. figure:: X.45.graphic.inverted.png
...
Let AB be a major straight line divided at C, so that AC, CB are incommensurable in square and make the sum of the squares on AC, CB rational, but the rectangle AC, CB medial; [:ref:`X.39`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.45" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/45/", target="_top"];
