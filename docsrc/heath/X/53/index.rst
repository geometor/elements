...
Let any rational straight line E be set out, and let it be contrived that, as D is to AB, so is the square on E to the square on FG; [:ref:`X.6.p.1`] therefore the square on E is commensurable with the square on FG. [:ref:`X.6`]
...
Again, let it be contrived that, as BA is to AC, so is the square on FG to the square on GH. [:ref:`X.6.p.1`]
...
Let then the squares on GH, K be equal to the square on FG; therefore, convertendo, as AB is to BC, so is the square on FG to the square on K. [:ref:`V.19.p.1`]
