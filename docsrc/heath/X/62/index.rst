...
:type: None
:tags: line
:dependencies: VI.1, X.11, X.22, X.36, X.38, elem.10.12 elem.10.13, elem.10.15 elem.10.23.p.1, elem.10.def.2.3




.. figure:: X.62.graphic.inverted.png
...
Then, since AB is a second bimedial divided at C, therefore AC, CB are medial straight lines commensurable in square only and containing a medial rectangle, [:ref:`X.38`] so that the sum of the squares on AC, CB is also medial. [:ref:`elem.10.15 elem.10.23.p.1`]

And it is equal to DL; therefore DL is also medial.

And it is applied to the rational straight line DE; therefore MD is also rational and incommensurable in length with DE. [:ref:`X.22`]
...
And, since AC is incommensurable in length with CB, and, as AC is to CB, so is the square on AC to the rectangle AC, CB, therefore the square on AC is also incommensurable with the rectangle AC, CB. [:ref:`X.11`]

Hence the sum of the squares on AC, CB is incommensurable with twice the rectangle AC, CB, [:ref:`elem.10.12 elem.10.13`] that is, DL is incommensurable with MF, so that DM is also incommensurable with MG. [:ref:`VI.1`, :ref:`X.11`]

And they are rational; therefore DG is binomial. [:ref:`X.36`]
...
Therefore DG is a third binomial straight line. [:ref:`elem.10.def.2.3`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "elem.10.12 elem.10.13" [style="rounded,filled", fillcolor=orange];
     ...
     "X.62" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/62/", target="_top"];
     ...
     "I.34" -> "I.26";
     "I.36" -> "I.33";
     "X.62" -> "elem.10.15 elem.10.23.p.1";
     "X.22" -> "X.21";
     "I.16" -> "I.10";
     "I.32" -> "I.31";
     "I.37" -> "I.31";
