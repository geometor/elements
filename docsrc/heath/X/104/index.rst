...
:type: None
:tags: line
:dependencies: V.12, V.16, VI.12, X.11, X.13, X.23, X.def.4, elem.10.23.p.1, elem.10.74 elem.10.75




.. figure:: X.104.graphic.inverted.png
...
Therefore AE, EB are medial straight lines commensurable in square only. [:ref:`elem.10.74 elem.10.75`]

Let it be contrived that, as AB is to CD, so is BE to DF; [:ref:`VI.12`] therefore AE is also commensurable with CF, and BE with DF. [:ref:`V.12`, :ref:`X.11`]

But AE, EB are medial straight lines commensurable in square only; therefore CF, FD are also medial straight lines [:ref:`X.23`] commensurable in square only; [:ref:`X.13`] therefore CD is an apotome of a medial straight line. [:ref:`elem.10.74 elem.10.75`]
...
But the square on AE is commensurable with the square on CF; therefore the rectangle AE, EB is also commensurable with the rectangle CF, FD. [:ref:`V.16`, :ref:`X.11`]

Therefore, if the rectangle AE, EB is rational, the rectangle CF, FD will also be rational, [:ref:`X.def.4`] and if the rectangle AE, EB is medial, the rectangle CF, FD is also medial. [:ref:`elem.10.23.p.1`]

Therefore CD is an apotome of a medial straight line and the same in order with AB. [:ref:`elem.10.74 elem.10.75`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "X.104" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/104/", target="_top"];
     ...
     "elem.10.74 elem.10.75" [style="rounded,filled", fillcolor=orange];
