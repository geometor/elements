...
:type: prop
:tags: line
:dependencies: V.19.p.1, V.22, X.36, X.6, X.6.p.1, X.9
...
Next let it be contrived that, as the number BA is to AC, so is the square on FG to the square on GH; [:ref:`X.6.p.1`] therefore the square on FG is commensurable with the square on GH. [:ref:`X.6`]
