...
Let it be contrived that, as E is to BC, so is the square on A to the square on FG, and, as BC is to CD, so is the square on FG to the square on GH. [:ref:`X.6.p.1`]
...
Since then, as BC is to CD, so is the square on FG to the square on GH, therefore, convertendo, as CB is to BD, so is the square on FG to the square on K. [:ref:`V.19.p.1`]
...
Therefore FH is a sixth apotome. [:ref:`X.def.3.6`]
