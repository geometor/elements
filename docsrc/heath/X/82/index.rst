...
.. figure:: X.82.graphic.inverted.png
...
therefore AC, CB are straight lines incommensurable in square which make the sum of the squares on them rational, but twice the rectangle contained by them medial. [:ref:`X.76`]

I say that no other straight line can be annexed to AB fulfilling the same conditions.

For, if possible, let BD be so annexed; therefore AD, DB are also straight lines incommensurable in square which fulfil the aforesaid conditions. [:ref:`X.76`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.82" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/82/", target="_top"];
