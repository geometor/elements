...
:type: None
:tags: line
:dependencies: VI.1, X.11, X.13, X.17, X.20, X.21, X.22, X.36, X.37, elem.10.15 elem.10.23.p.1, elem.10.def.2.2




.. figure:: X.61.graphic.inverted.png
...
Then, since AB is a first bimedial divided at C, therefore AC, CB are medial straight lines commensurable in square only, and containing a rational rectangle, [:ref:`X.37`] so that the squares on AC, CB are also medial. [:ref:`X.21`]

Therefore DL is medial. [:ref:`elem.10.15 elem.10.23.p.1`]

And it has been applied to the rational straight line DE; therefore MD is rational and incommensurable in length with DE. [:ref:`X.22`]

Again, since twice the rectangle AC, CB is rational, MF is also rational.

And it is applied to the rational straight line ML; therefore MG is also rational and commensurable in length with ML, that is, DE; [:ref:`X.20`] therefore DM is incommensurable in length with MG. [:ref:`X.13`]
...
For, since the squares on AC, CB are greater than twice the rectangle AC, CB, therefore DL is also greater than MF, so that DM is also greater than MG. [:ref:`VI.1`]
...
And the rectangle DK, KM is equal to the square on MN; therefore the square on DM is greater than the square on MG by the square on a straight line commensurable with DM. [:ref:`X.17`]

And MG is commensurable is length with DE.

Therefore DG is a second binomial straight line. [:ref:`elem.10.def.2.2`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.61" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/61/", target="_top"];
     ...
     "I.34" -> "I.26";
     "I.36" -> "I.33";
     "X.61" -> "elem.10.15 elem.10.23.p.1";
     "X.22" -> "X.21";
     "X.61" -> "X.21";
     "I.16" -> "I.10";
     "I.32" -> "I.31";
