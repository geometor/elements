...
:type: prop
:tags: line
:dependencies: II.7, VI.1, X.11, X.13, X.15, X.20, X.22, X.23.p.1, X.28, X.6, X.73, elem.10.15 elem.10.23.p.1
...
Again, since the rectangle AB, BC is medial, therefore twice the rectangle AB, BC is also medial. [:ref:`X.23.p.1`]
