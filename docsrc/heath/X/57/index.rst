...
:type: prop
:tags: line
:dependencies: VI.1, X.11, X.13, X.18, X.19, X.21, X.39, elem.10.def.2.4




.. figure:: X.57.graphic.inverted.png
...
For, since AD is a fourth binomial straight line, therefore AE, ED are rational straight lines commensurable in square only, the square on AE is greater than the square on ED by the square on a straight line incommensurable with AE, and AE is commensurable in length with AB. [:ref:`elem.10.def.2.4`]

Let DE be bisected at F, and let there be applied to AE a parallelogram, the rectangle AG, GE, equal to the square on EF; therefore AG is incommensurable in length with GE. [:ref:`X.18`]
...
Since AG is incommensurable with EG, AH is also incommensurable with GK, that is, SN with NQ; [:ref:`VI.1`, :ref:`X.11`] therefore MN, NO are incommensurable in square.

And, since AE is commensurable with AB, AK is rational; [:ref:`X.19`] and it is equal to the squares on MN, NO; therefore the sum of the squares on MN, NO is also rational.

And, since DE is incommensurable in length with AB, that is, with EK, while DE is commensurable with EF, therefore EF is incommensurable in length with EK. [:ref:`X.13`]

Therefore EK, EF are rational straight lines commensurable in square only; therefore LE, that is, MR, is medial. [:ref:`X.21`]
...
But, if two straight lines incommensurable in square and making the sum of the squares on them rational, but the rectangle contained by them medial, be added together, the whole is irrational and is called major. [:ref:`X.39`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.57" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/57/", target="_top"];
