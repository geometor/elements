...
:type: prop
:tags: line
:dependencies: V.11, VI.1, VI.17, VI.26, X.11, X.13, X.15, X.17, X.21, X.75, elem.10.def.3.3




.. figure:: X.93.graphic.inverted.png
...
Therefore AF, FG are commensurable; therefore AI is also commensurable with FK. [:ref:`VI.1`, :ref:`X.11`]

And, since AF, FG are commensurable in length, therefore AG is also commensurable in length with each of the straight lines AF, FG. [:ref:`X.15`]

But AG is rational and incommensurable in length with AC; so that AF, FG are so also. [:ref:`X.13`]

Therefore each of the rectangles AI, FK is medial. [:ref:`X.21`]

Again, since DE is commensurable in length with EG, therefore DG is also commensurable in length with each of the straight lines DE, EG. [:ref:`X.15`]

But GD is rational and incommensurable in length with AC; therefore each of the straight lines DE, EG is also rational and incommensurable in length with AC; [:ref:`X.13`] therefore each of the rectangles DH, EK is medial. [:ref:`X.21`]

And, since AG, GD are commensurable in square only, therefore AG is incommensurable in length with GD.

But AG is commensurable in length with AF, and DG with EG; therefore AF is incommensurable in length with EG. [:ref:`X.13`]

But, as AF is to EG, so is AI to EK; [:ref:`VI.1`] therefore AI is incommensurable with EK. [:ref:`X.11`]

Now let the square LM be constructed equal to AI, and let there be subtracted NO equal to FK and being about the same angle with LM; therefore LM, NO are about the same diameter. [:ref:`VI.26`]

Let PR be their diameter, and let the figure be drawn.

Now, since the rectangle AF, FG is equal to the square on EG, therefore, as AF is to EG, so is EG to FG. [:ref:`VI.17`]

But, as AF is to EG, so is AI to EK, and, as EG is to FG, so is EK to FK; [:ref:`VI.1`] therefore also, as AI is to EK, so is EK to FK; [:ref:`V.11`] therefore EK is a mean proportional between AI, FK.
...
And, since AI is commensurable with FK, [:ref:`VI.1`, :ref:`X.11`] therefore the square on LP is also commensurable with the square on PN.

Again, since AI was proved incommensurable with EK, therefore LM is also incommensurable with MN, that is, the square on LP with the rectangle LP, PN; so that LP is also incommensurable in length with PN; [:ref:`VI.1`, :ref:`X.11`] therefore LP, PN are medial straight lines commensurable in square only.
...
Therefore LN is a second apotome of a medial straight line; [:ref:`X.75`] and it is the side
of the area AB.
...
.. graphviz::
   ...
   digraph {
     ...
     "elem.10.def.3.3" [style="rounded,filled", fillcolor=orange];
     ...
     "X.28" [URL="/heath/X/28/", target="_top"];
     ...
     "elem.10.15 elem.10.23.p.1" [style="rounded,filled", fillcolor=orange];
     ...
     "X.93" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/93/", target="_top"];
     ...
     "X.75" [URL="/heath/X/75/", target="_top"];
     ...
     "IX.1" [URL="/heath/IX/1/", target="_top"];
     ...
     "elem.9.24 elem.9.26" [style="rounded,filled", fillcolor=orange];
     ...
     "V.18" -> "V.14";
     "X.23" -> "X.def.3";
     "X.75" -> "elem.10.15 elem.10.23.p.1";
     "V.15" -> "V.12";
     "X.75" -> "X.73";
     "V.16" -> "V.20";
     "V.22" -> "V.20";
