...
:type: prop
:tags: line
:dependencies: V.def.9, X.11, X.6, X.6.p.1, X.9
...
—for we have learnt how to do this— [:ref:`X.6.p.1`] therefore the square on A is commensurable with the square on D. [:ref:`X.6`]
