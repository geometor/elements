...
:type: None
:tags: line
:dependencies: X.16, X.33, X.def.4, elem.10.6 elem.10.23.p.1




.. figure:: X.39.graphic.inverted.png
...
For let two straight lines AB, BC incommensurable in square, and fulfilling the given conditions [:ref:`X.33`
], be added together; I say that AC is irrational.

For, since the rectangle AB, BC is medial, twice the rectangle AB, BC is also medial. [:ref:`elem.10.6 elem.10.23.p.1`]

But the sum of the squares on AB, BC is rational; therefore twice the rectangle AB, BC is incommensurable with the sum of the squares on AB, BC, so that the squares on AB, BC together with twice the rectangle AB, BC that is, the square on AC, is also incommensurable with the sum of the squares on AB, BC; [:ref:`X.16`
] therefore the square on AC is irrational, so that AC is also irrational. [:ref:`X.def.4`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.39" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/39/", target="_top"];
