...
.. figure:: X.36.graphic.inverted.png
...
For, since AB is incommensurable in length with BC— for they are commensurable in square only— and, as AB is to BC, so is the rectangle AB, BC to the square on BC, therefore the rectangle AB, BC is incommensurable with the square on BC. [:ref:`X.11`
]

But twice the rectangle AB, BC is commensurable with the rectangle AB, BC [:ref:`X.6`
], and the squares on AB, BC are commensurable with the square on BC—for AB, BC are rational straight lines commensurable in square only— [:ref:`X.15`
] therefore twice the rectangle AB, BC is incommensurable with the squares on AB, BC. [:ref:`X.13`
]

And, componendo, twice the rectangle AB, BC together with the squares on AB, BC, that is, the square on AC [:ref:`II.4`
], is incommensurable with the sum of the squares on AB, BC. [:ref:`X.16`
]

But the sum of the squares on AB, BC is rational; therefore the square on AC is irrational, so that AC is also irrational. [:ref:`X.def.4`
]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.36" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/36/", target="_top"];
