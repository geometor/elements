...
And they are applied to the rational straight line EF; therefore each of the straight lines HE, EG is rational and incommensurable in length with EF. [:ref:`X.22`]

And, since [DB is rational and is equal to KH, therefore] KH is [also] rational; and it is applied to the rational straight line EF; therefore GH is rational and commensurable in length with EF. [:ref:`X.20`]

But EG is also rational, and is incommensurable in length with EF; therefore EG is incommensurable in length with GH. [:ref:`X.13`]

And, as EG is to GH, so is the square on EG to the rectangle EG, GH; therefore the square on EG is incommensurable with the rectangle EG, GH. [:ref:`X.11`]

But the squares on EG, GH are commensurable with the square on EG, for both are rational; and twice the rectangle EG, GH is commensurable with the rectangle EG, GH, for it is double of it; [:ref:`X.6`] therefore the squares on EG, GH are incommensurable with twice the rectangle EG, GH; [:ref:`X.13`] therefore also the sum of the squares on EG, GH and twice the rectangle EG, GH, that is, the square on EH [:ref:`II.4`], is incommensurable with the squares on EG, GH. [:ref:`X.16`]

But the squares on EG, GH are rational; therefore the square on EH is irrational. [:ref:`X.def.4`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.26" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/26/", target="_top"];
