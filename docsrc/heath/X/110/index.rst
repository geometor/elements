...
:type: prop
:tags: line
:dependencies: VI.1, X.11, X.22, X.73, X.93, X.96, elem.10.def.3.3, elem.10.def.3.6




.. figure:: X.110.graphic.inverted.png
...
For, since each of the rectangles BC, BD is medial, and BC is incommensurable with BD, it follows that each of the straight lines FH, FK will be rational and incommensurable in length with FG. [:ref:`X.22`]

And, since BC is incommensurable with BD, that is, GH with GK, HF is also incommensurable with FK; [:ref:`VI.1`, :ref:`X.11`] therefore FH, FK are rational straight lines commensurable in square only; therefore KH is an apotome. [:ref:`X.73`]

If then the square on FH is greater than the square on FK by the square on a straight line commensurable with FH, while neither of the straight lines FH, FK is commensurable in length with the rational straight line FG set out, KH is a third apotome. [:ref:`elem.10.def.3.3`]
...
of it is irrational, and is called a second apotome of a medial straight line; [:ref:`X.93`] so that the side
of LH, that is, of EC, is a second apotome of a medial straight line.

But, if the square on FH is greater than the square on FK by the square on a straight line incommensurable with FH, while neither of the straight lines HF, FK is commensurable in length with FG, KH is a sixth apotome. [:ref:`elem.10.def.3.6`]

But the side
of the rectangle contained by a rational straight line and a sixth apotome is a straight line which produces with a medial area a medial whole. [:ref:`X.96`]
...
.. graphviz::
   ...
   digraph {
     ...
     "X.96" [URL="/heath/X/96/", target="_top"];
     ...
     "X.110" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/110/", target="_top"];
     ...
     "X.93" [URL="/heath/X/93/", target="_top"];
