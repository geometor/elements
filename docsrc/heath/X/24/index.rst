...
:type: None
:tags: line
:dependencies: VI.1, X.11, elem.10.23.p.1




.. figure:: X.24.graphic.inverted.png
...
And, since AB is commensurable in length with BC, while AB is equal to BD, therefore DB is also commensurable in length with BC; so that DA is also commensurable with AC. [:ref:`VI.1`, :ref:`X.11`]

But DA is medial; therefore AC is also medial. [:ref:`elem.10.23.p.1`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "X.24" [style="rounded,filled", fillcolor=lightblue, URL="/heath/X/24/", target="_top"];
