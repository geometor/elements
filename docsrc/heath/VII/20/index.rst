...
:number: 291
:type: prop
:dependencies: VII.12, VII.13, VII.4, VII.def.20




.. figure:: VII.20.graphic.inverted.png
...
For, if possible, let it be so; therefore EF is also the same parts of B that CD is of A. [:ref:`VII.13` and :ref:`VII.def.20`]
...
Therefore also, as one of the antecedents is to one of the consequents, so will all the antecedents be to all the consequents. [:ref:`VII.12`]
...
Therefore CD is not parts of A; therefore it is a part of it. [:ref:`VII.4`]

And EF is the same part of B that CD is of A; [:ref:`VII.13` and :ref:`VII.def.20`] therefore CD measures A the same number of times that EF measures B. Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.20" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VII/20/", target="_top"];
