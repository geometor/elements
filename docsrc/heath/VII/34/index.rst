...
.. figure:: VII.34.graphic.inverted.png
...
First, let A, B be prime to one another, and let A by multiplying B make C; therefore also B by multiplying A has made C. [:ref:`VII.16`]
...
Then, as many times as A measures D, so many units let there be in E, and, as many times as B measures D, so many units let there be in F; therefore A by multiplying E has made D, and B by multiplying F has made D; [:ref:`VII.def.15`] therefore the product of A, E is equal to the product of B, F.

Therefore, as A is to B, so is F
E. [:ref:`VII.19`]

But A, B are prime, primes are also least, [:ref:`VII.21`] and the least measure the numbers which have the same ratio the same number of times, the greater the greater and the less the less; [:ref:`VII.20`] therefore B measures E, as consequent consequent.

And, since A by multiplying B, E has made C, D, therefore, as B is to E, so is C to D. [:ref:`VII.17`]
...
Next, let A, B not be prime to one another, and let F, E, the least numbers of those which have the same ratio with A, B, be taken; [:ref:`VII.33`] therefore the product of A, E is equal to the product of B, F. [:ref:`VII.19`]
...
Therefore the product of A, G is equal to the product of B, H; therefore, as A is to B, so is H to G. [:ref:`VII.19`]

But, as A is to B, so is F to E.

Therefore also, as F is to E, so is H to G.

But F, E are least, and the least measure the numbers which have the same ratio the same number of times, the greater the greater and the less the less; [:ref:`VII.20`] therefore E measures G.

And, since A by multiplying E, G has made C, D, therefore, as E is to G, so is C to D. [:ref:`VII.17`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.34" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VII/34/", target="_top"];
