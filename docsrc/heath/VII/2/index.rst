...
.. figure:: VII.2.graphic.inverted.png
...
For an unit will not be left; otherwise AB, CD will be prime to one another [:ref:`VII.1`], which is contrary to the hypothesis.
