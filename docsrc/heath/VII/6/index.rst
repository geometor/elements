...
And since, whatever part AG is of C, the same part is DH of F also, therefore, whatever part AG is of C, the same part also is the sum of AG, DH of the sum of C, F. [:ref:`VII.5`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.6" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VII/6/", target="_top"];
     "VII.6" -> "VII.5";
   }
