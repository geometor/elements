...
.. figure:: VII.6.graphic.inverted.png
...
And since, whatever part AG is of C, the same part is DH of F also, therefore, whatever part AG is of C, the same part also is the sum of AG, DH of the sum of C, F. [:ref:`VII.5 <VII.5>`]
...
.. graphviz::
   ...
   digraph {
     ...
     rankdir="TB";
     "VII.6" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/VII/6/", target="_top"];
