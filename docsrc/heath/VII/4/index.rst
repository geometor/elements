...
.. figure:: VII.4.graphic.inverted.png
...
But, if not, let the greatest common measure D of A, BC be taken; [:ref:`VII.2`] and let BC be divided into the numbers equal to D, namely BE, EF, FC.
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.4" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VII/4/", target="_top"];
