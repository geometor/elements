...
.. figure:: VII.18.graphic.inverted.png
...
For, since A by multiplying C has made D, therefore also C by multiplying A has made D. [:ref:`VII.16`] For the same reason also C by multiplying B has made E.

Therefore the number C by multiplying the two numbers A, B has made D, E.

Therefore, as A is to B, so is D to E. [:ref:`VII.17`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.18" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VII/18/", target="_top"];
