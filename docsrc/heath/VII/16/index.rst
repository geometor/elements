...
.. figure:: VII.16.graphic.inverted.png
...
Therefore, alternately, the unit E measures the number B the same number of times that A measures C. [:ref:`VII.15`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.16" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VII/16/", target="_top"];
