...
:number: 283
:type: prop
:dependencies: VII.def.20, elem.7.5 elem.7.6




.. figure:: VII.12.graphic.inverted.png
...
For since, as A is to B, so is C to D, whatever part or parts A is of B, the same part or parts is C of D also. [:ref:`VII.def.20`]

Therefore also the sum of A, C is the same part or the same parts of the sum of B, D that A is of B. [:ref:`elem.7.5 elem.7.6`]

Therefore, as A is to B, so are A, C to B, D. [:ref:`VII.def.20`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VII.12" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VII/12/", target="_top"];
     "VII.12" -> "VII.def.20";
