...
.. figure:: IV.4.graphic.inverted.png
...
.. container:: center
   ...
   therefore they will also have the remaining sides equal to the remaining sides; [:ref:`I.26`]
...
For, if it cuts them, the straight line drawn at right angles to the diameter of the circle from its extremity will be found to fall within the circle : which was proved absurd; [:ref:`III.16`]
...
.. container:: center
   ...
   therefore it will touch them, and will be the circle inscribed in the triangle ``ABC``. [:ref:`IV.def.5`]
...
(καὶ διαστήματι ὲνὶ τῶν E, Z, H) and the like. In one case (:ref:`IV.13`) he actually has with distance one of the ``points G``, ``H``, ``K``, ``L``, ``M``
...
.. graphviz::
   ...
   digraph {
     ...
     "III.16" [URL="/heath/III/16/", target="_top"];
     "IV.4" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IV/4/", target="_top"];
     "I.26" [URL="/heath/I/26/", target="_top"];
     "I.7" [URL="/heath/I/7/", target="_top"];
     "I.3" [URL="/heath/I/3/", target="_top"];
     "IV.13" [URL="/heath/IV/13/", target="_top"];
     ...
     "IV.def.5" [style="rounded,filled", fillcolor=orange, URL="/heath/IV/def.5/", target="_top"];
     "I.11" -> "I.def.10";
     "I.13" -> "I.def.10";
     "I.13" -> "I.11";
     "I.15" -> "I.post.4";
