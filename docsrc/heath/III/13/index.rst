...
.. figure:: III.13.graphic.inverted.png
...
.. graphviz::
   ...
   digraph {
     ...
     "III.2" [URL="/heath/III/2/", target="_top"];
     ...
     "III.def.3" [style="rounded,filled", fillcolor=orange, URL="/heath/III/def.3/", target="_top"];
     ...
     "III.13" [style="rounded,filled", fillcolor=lightblue, URL="/heath/III/13/", target="_top"];
     "I.10" [URL="/heath/I/10/", target="_top"];
     "III.11" [style="rounded,filled", fillcolor=orange, URL="/heath/III/11/", target="_top"];
     "I.11" -> "I.def.10";
     "I.13" -> "I.def.10";
     "III.1" -> "I.def.10";
     "I.13" -> "I.11";
