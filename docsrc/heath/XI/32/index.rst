...
:number: 564
:type: prop
:dependencies: I.45, XI.25, XI.31




.. figure:: XI.32.graphic.inverted.png
...
For let FH equal to AE be applied to FG, [:ref:`I.45`] and on FH as base, and with the same height as that of CD, let the parallelepipedal solid GK be completed.

Then the solid AB is equal to the solid GK; for they are on equal bases AE, FH and of the same height. [:ref:`XI.31`]

And, since the parallelepipedal solid CK is cut by the plane DG which is parallel to opposite planes, therefore, as the base CF is to the base FH, so is the solid CD to the solid DH. [:ref:`XI.25`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XI.32" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XI/32/", target="_top"];
...
:ref:`XI.33`, :ref:`XI.34`, :ref:`XI.37`, :ref:`XII.10`, :ref:`XII.11`, :ref:`XII.12`, :ref:`XII.13`, :ref:`XII.14`, :ref:`XII.15`, :ref:`XII.4`, :ref:`XII.5`, :ref:`XII.6`, :ref:`XII.7`, :ref:`XII.8`, :ref:`XII.9`