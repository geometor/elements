...
.. figure:: XI.28.graphic.inverted.png
...
For, since the triangle CGF is equal to the triangle CFB, [:ref:`I.34`] and ADE to DEH, while the parallelogram CA is also equal to the parallelogram EB, for they are opposite, and GE to CH, therefore the prism contained by the two triangles CGF, ADE and the three parallelograms GE, AC, CE is also equal to the prism contained by the two triangles CFB, DEH and the three parallelograms CH, BE, CE; for they are contained by planes equal both in multitude and in magnitude. [:ref:`XI.def.10`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XI.28" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XI/28/", target="_top"];
