...
:type: prop
:tags: triangle
:dependencies: I.34, XI.28, XI.31




.. figure:: XI.39.graphic.inverted.png
...
Since the parallelogram AF is double of the triangle GHK, while the parallelogram HK is also double of the triangle GHK, [:ref:`I.34`] therefore the parallelogram AF is equal to the parallelogram HK.

But parallelepipedal solids which are on equal bases and of the same height are equal to one another; [:ref:`XI.31`] therefore the solid AO is equal to the solid GP.

And the prism ABCDEF is half of the solid AO, and the prism GHKLMN is half of the solid GP; [:ref:`XI.28`] therefore the prism ABCDEF is equal to the prism GHKLMN.
...
.. graphviz::
   ...
   digraph {
     ...
     "XI.39" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XI/39/", target="_top"];
...
:ref:`XII.11`, :ref:`XII.12`, :ref:`XII.13`, :ref:`XII.14`, :ref:`XII.15`, :ref:`XII.3`, :ref:`XII.4`, :ref:`XII.5`, :ref:`XII.6`, :ref:`XII.7`, :ref:`XII.8`