...
Now, since each of the straight lines EQ, KU is at right angles to the same plane, therefore EQ is parallel to KU. [:ref:`XI.6 <XI.6>`]

But it is also equal to it; and the straight lines joining those extremities of equal and parallel straight lines which are in the same direction are equal and parallel. [:ref:`I.33 <I.33>`]
...
And, since QE belongs to a hexagon, and EP to a decagon, and the angle QEP is right, therefore QP belongs to a pentagon; for the square on the side of the pentagon is equal to the square on the side of the hexagon and the square on the side of the decagon inscribed in the same circle. [:ref:`XIII.10 <XIII.10>`]
...
Now, since each of the straight lines VW, QE is at right angles to the plane of the circle, therefore VW is parallel to QE. [:ref:`XI.6 <XI.6>`]

But they are also equal; therefore EV, QW are also equal and parallel. [:ref:`I.33 <I.33>`]

But EV belongs to a hexagon; therefore QW also belongs to a hexagon.

And, since QW belongs to a hexagon, and WZ to a decagon, and the angle QWZ is right, therefore QZ belongs to a pentagon. [:ref:`XIII.10 <XIII.10>`]

For the same reason UZ also belongs to a pentagon, inasmuch as, if we join VK, WU, they will be equal and opposite, and VK, being a radius, belongs to a hexagon; [:ref:`IV.15.p.1 <IV.15.p.1>`] therefore WU also belongs to a hexagon.

But WZ belongs to a decagon, and the angle UWZ is right; therefore UZ belongs to a pentagon. [:ref:`XIII.10 <XIII.10>`]
...
Again, since VL belongs to a hexagon, and VX to a decagon, and the angle LVX is right, therefore LX belongs to a pentagon. [:ref:`XIII.10 <XIII.10>`]
...
For, since VW belongs to a hexagon, and WZ to a decagon, therefore VZ has been cut in extreme and mean ratio at W, and VW is its greater segment; [:ref:`XIII.9 <XIII.9>`] therefore, as ZV is to VW, so is VW to WZ.
...
And for this reason again, if we join QX, the angle at Q will be right; [:ref:`VI.8 <VI.8>`] therefore the semicircle described on XZ will also pass through Q. [:ref:`III.31 <III.31>`]
...
Then, since the straight line VZ has been cut in extreme and mean ratio at W, and ZW is its lesser segment, therefore the square on ZW added to the half of the greater segment, that is WA', is five times the square on the half of the greater segment; [:ref:`XIII.3 <XIII.3>`] therefore the square on ZA' is five times the square on .
...
But, as AB is to BC, so is the square on AB to the square on BD; [:ref:`VI.8 <VI.8>`, :ref:`V.def.9 <V.def.9>`] therefore the square on AB is five times the square on BD.
...
But, if an equilateral pentagon be inscribed in a circle which has its diameter rational, the side of the pentagon is the irrational straight line called minor. [:ref:`XIII.11 <XIII.11>`]
...
.. graphviz::
   ...
   digraph {
     ...
     "XIII.10" [fillcolor="#222244", URL="/heath/XIII/10/", target="_top"];
     ...
     "XIII.3" [fillcolor="#222244", URL="/heath/XIII/3/", target="_top"];
     ...
     "XIII.16" [penwidth=3, color="white", fillcolor="#555555", URL="/heath/XIII/16/", target="_top"];
     ...
     "II.2" [fillcolor="#222244", URL="/heath/II/2/", target="_top"];
     ...
     "XIII.9" [fillcolor="#222244", URL="/heath/XIII/9/", target="_top"];
     ...
     "XIII.11" [fillcolor="#222244", URL="/heath/XIII/11/", target="_top"];
