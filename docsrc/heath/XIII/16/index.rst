...
:tags: line
:dependencies: I.33, III.31, IV.15.p.1, V.def.9, VI.8, XI.6, XIII.10, XIII.11, XIII.3, XIII.9
...
For the same reason UZ also belongs to a pentagon, inasmuch as, if we join VK, WU, they will be equal and opposite, and VK, being a radius, belongs to a hexagon; [:ref:`IV.15.p.1`] therefore WU also belongs to a hexagon.
