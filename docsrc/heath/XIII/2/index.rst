...
:type: prop
:tags: line
:dependencies: II.4, VI.1




.. figure:: XIII.2.graphic.inverted.png
...
And, since DC is double of CA, while DC is equal to CK, and AC to CH, therefore KB is also double of BH. [:ref:`VI.1`]
...
But, by hypothesis, the square on BA is also five times the square on CA; therefore the square on BA is equal to the squares on BC, CA: which is impossible. [:ref:`II.4`] 
...
.. graphviz::
   ...
   digraph {
     ...
     "XIII.2" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XIII/2/", target="_top"];
