...
Then, since the angle KEG is right, because KE is also at right angles to the plane EG and of course to the straight line EG also, [:ref:`XI.def.3`] therefore the semicircle described on KG will also pass through the point E.
...
But EF is equal to EK; therefore the square on EG is double of the square on EK; hence the squares on GE, EK, that is the square on GK [:ref:`I.47`], is triple of the square on EK.
...
.. graphviz::
   ...
   digraph {
     ...
     "XIII.15" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XIII/15/", target="_top"];
