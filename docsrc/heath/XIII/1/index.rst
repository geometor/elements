...
.. figure:: XIII.1.graphic.inverted.png
...
Now, since AB has been cut in extreme and mean ratio at C, therefore the rectangle AB, BC is equal to the square on AC. [:ref:`VI.def.3`, :ref:`VI.17`]
...
But, as KA is to AH, so is CK to CH; [:ref:`VI.1`] therefore CK is double of CH.
...
.. graphviz::
   ...
   digraph {
     ...
     "XIII.1" [style="rounded,filled", fillcolor=lightblue, URL="/heath/XIII/1/", target="_top"];
