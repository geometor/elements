...
Since then C by multiplying the numbers C, D has made A, E respectively, therefore, as C is to D, so is A to E. [:ref:`VII.17`]
...
.. container:: center
   ...
   as C is to D, so is E to B. [:ref:`VII.18`]
...
For, since A, E, B are three numbers in proportion, therefore A has to B the ratio duplicate of that which A has to E. [:ref:`V.def.9`]
