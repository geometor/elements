...
.. figure:: VIII.7.graphic.inverted.png
...
For, if A does not measure B, neither will any other of the numbers measure any other. [:ref:`VIII.6`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VIII.7" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VIII/7/", target="_top"];
