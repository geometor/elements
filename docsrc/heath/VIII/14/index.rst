...
For let C by multiplying D make E; therefore A, E, B are continuously proportional in the ratio of C to D. [:ref:`VIII.11`]

And, since A, E, B are continuously proportional, and A measures B, therefore A also measures E. [:ref:`VIII.7`]

And, as A is to E, so is C to D; therefore also C measures D. [:ref:`VII.def.20`]
...
And since, as C is to D, so is A to E, and C measures D, therefore A also measures E. [:ref:`VII.def.20`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VIII.14" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VIII/14/", target="_top"];
