...
:number: 313
:type: prop
:dependencies: VII.22, VII.27, VII.33, VIII.2, elem.8.2.p.1




.. figure:: VIII.3.graphic.inverted.png
...
For let two numbers E, F, the least that are in the ratio of A, B, C, D, be taken, [:ref:`VII.33`] then three others G, H, K with the same property; and others, more by one continually, [:ref:`VIII.2`] until the multitude taken becomes equal to the multitude of the numbers A, B, C, D.

Let them be taken, and let them be L, M, N, O.

Now, since E, F are the least of those which have the same ratio with them, they are prime to one another. [:ref:`VII.22`]

And, since the numbers E, F by multiplying themselves respectively have made the numbers G, K, and by multiplying the numbers G, K respectively have made the numbers L, O, [:ref:`elem.8.2.p.1`] therefore both G, K and L, O are prime to one another. [:ref:`VII.27`]
...
.. graphviz::
   ...
   digraph {
     ...
     "VIII.3" [style="rounded,filled", fillcolor=lightblue, URL="/heath/VIII/3/", target="_top"];
...
:ref:`IX.1`, :ref:`IX.10`, :ref:`IX.12`, :ref:`IX.13`, :ref:`IX.3`, :ref:`IX.32`, :ref:`IX.36`, :ref:`IX.4`, :ref:`IX.5`, :ref:`IX.6`, :ref:`IX.8`, :ref:`IX.9`, :ref:`VIII.14`, :ref:`VIII.15`, :ref:`VIII.16`, :ref:`VIII.17`, :ref:`VIII.21`, :ref:`VIII.23`, :ref:`VIII.24`, :ref:`VIII.25`, :ref:`VIII.6`, :ref:`VIII.7`, :ref:`VIII.8`, :ref:`X.110`, :ref:`X.28`, :ref:`X.75`, :ref:`X.81`, :ref:`X.93`, :ref:`X.99`