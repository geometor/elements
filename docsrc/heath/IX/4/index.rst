...
.. figure:: IX.4.graphic.inverted.png
...
And, since A by multiplying itself has made D, and by multiplying B has made C therefore, as A is to B, so is D to C. [:ref:`VII.17`]

And, since A, B are cube numbers, A, B are similar solid numbers.

Therefore two mean proportional numbers fall between A, B; [:ref:`VIII.19`] so that two mean proportional numbers will fall between D, C also. [:ref:`VIII.8`]

And D is cube; therefore C is also cube [:ref:`VIII.23`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "IX.4" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IX/4/", target="_top"];
