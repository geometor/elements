...
For, since AB is even, it has a half part. [:ref:`VII.def.6`]
...
.. graphviz::
   ...
   digraph {
     ...
     "IX.24" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IX/24/", target="_top"];
     "IX.24" -> "VII.def.6";
   }
