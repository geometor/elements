...
For, however many A, B, C, D are in multitude, let so many E, HK, L, M be taken in double proportion beginning from E; therefore, ex aequali, as A is to D, so is E to M. [:ref:`VII.14`]

Therefore the product of E, D is equal to the product of A, M. [:ref:`VII.19`]
...
Now let there be subtracted from the second HK and the last FG the numbers HN, FO, each equal to the first E; therefore, as the excess of the second is to the first, so is the excess of the last to all those before it. [:ref:`IX.35`]
...
But, further, E has also by multiplying D made FG; therefore, as E is to Q, so is P to D. [:ref:`VII.19`]

And, since A, B, C, D are continuously proportional beginning from an unit, therefore D will not be measured by any other number except A, B, C. [:ref:`IX.13`]

And, by hypothesis, P is not the same with any of the numbers A, B, C; therefore P will not measure D.

But, as P is to D, so is E to Q; therefore neither does E measure Q. [:ref:`VII.def.20`]

And E is prime; and any prime number is prime to any number which it does not measure. [:ref:`VII.29`]

Therefore E, Q are prime to one another.

But primes are also least, [:ref:`VII.21`] and the least numbers measure those which have the same ratio the same number of times, the antecedent the antecedent and the consequent the consequent; [:ref:`VII.20`] and, as E is to Q, so is P to D; therefore E measures P the same number of times that Q measures D.
...
Now E, HK, L are in the same ratio with B, C, D; therefore, ex aequali, as B is to D, so is E to L. [:ref:`VII.14`]

Therefore the product of B, L is equal to the product of D, E. [:ref:`VII.19`]

But the product of D, E is equal to the product of Q, P; therefore the product of Q, P is also equal to the product of B, L.

Therefore, as Q is to B, so is L to P. [:ref:`VII.19`]
...
And FG was proved equal to A, B, C, D, E, HK, L, M and the unit; and a perfect number is that which is equal to its own parts; [:ref:`VII.def.22`] therefore FG is perfect. Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "IX.35" [URL="/heath/IX/35/", target="_top"];
     "VIII.21" [URL="/heath/VIII/21/", target="_top"];
     "V.7" [URL="/heath/V/7/", target="_top"];
     "V.9" [URL="/heath/V/9/", target="_top"];
     "IX.36" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IX/36/", target="_top"];
     ...
     "VII.def.14" [style="rounded,filled", fillcolor=orange, URL="/heath/VII/def.14/", target="_top"];
     ...
     "elem.9.11 elem.9.11.p.1" [style="rounded,filled", fillcolor=orange];
     ...
     "VII.def.22" [style="rounded,filled", fillcolor=orange, URL="/heath/VII/def.22/", target="_top"];
