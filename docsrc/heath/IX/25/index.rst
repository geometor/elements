...
.. figure:: IX.25.graphic.inverted.png
...
For let the unit CD be subtracted from BC; therefore DB is even. [:ref:`VII.def.7`]

But AB is also even; therefore the remainder AD is also even. [:ref:`IX.24`]

And CD is an unit; therefore CA is odd. [:ref:`VII.def.7`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "IX.25" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IX/25/", target="_top"];
     "IX.25" -> "IX.24";
     "IX.25" -> "VII.def.7";
     "IX.24" -> "VII.def.6";
   }
