...
.. figure:: IX.3.graphic.inverted.png
...
But further the unit also measures C according to the units in it; therefore, as the unit is to C, so is C to D. [:ref:`VII.def.20`]
...
But the unit also measures A according to the units in it; therefore, as the unit is to A, so is A to B. [:ref:`VII.def.20`]

But between the unit and A two mean proportional numbers have fallen; therefore two mean proportional numbers will also fall between A, B. [:ref:`VIII.8`]

But, if two mean proportional numbers fall between two numbers, and the first be cube, the second will also be cube. [:ref:`VIII.23`]
...
.. graphviz::
   ...
   digraph {
     ...
     "IX.3" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IX/3/", target="_top"];
     "VIII.3" -> "VII.33";
     "VIII.8" -> "VII.33";
     "VIII.20" -> "VII.33";
     "VIII.21" -> "VII.33";
