...
:number: 343
:type: prop
:dependencies: VII.def.20, VIII.19, VIII.23, VIII.8




.. figure:: IX.6.graphic.inverted.png
...
Therefore, as the unit is to A, so is A to B. [:ref:`VII.def.20`]

And, since A by multiplying B has made C, therefore B measures C according to the units in A.

But the unit also measures A according to the units in it.

Therefore, as the unit is to A, so is B to C. [:ref:`VII.def.20`]
...
Therefore there are two mean proportional numbers between B, C. [:ref:`VIII.19`]

And, as B is to C, so is A to B.

Therefore there are two mean proportional numbers between A, B also. [:ref:`VIII.8`]

And B is cube; therefore A is also cube. [cf. :ref:`VIII.23`] Q. E. D.
...
.. graphviz::
   ...
   digraph {
     ...
     "IX.6" [style="rounded,filled", fillcolor=lightblue, URL="/heath/IX/6/", target="_top"];
